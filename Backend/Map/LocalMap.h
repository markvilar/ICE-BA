...
public:
    ...
    public:
        inline CameraLF() {}
        inline CameraLF(const Camera& C, const int iFrm,
            const ubyte uc = LM_FLAG_FRAME_DEFAULT)
    ...
    public:
        ...
        inline CameraKF(const Rigid3D& C, const int iFrm,
...
public:
    ...
    ubyte IBA_Synchronize(const int iFrm, std::list<CameraLF>& CsLF,
