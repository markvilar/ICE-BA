...
public:
    inline const xp128f& v0123() const { return m_data4[0]; }
    inline xp128f& v0123() { return m_data4[0]; }
    inline const xp128f& v4567() const { return m_data4[1]; }
    inline xp128f& v4567() { return m_data4[1]; }
    inline const float& v0() const { return m_data[0]; }
    inline float& v0() { return m_data[0]; }
    inline const float& v1() const { return m_data[1]; }
    inline float& v1() { return m_data[1]; }
    inline const float& v2() const { return m_data[2]; }
    inline float& v2() { return m_data[2]; }
    inline const float& v3() const { return m_data[3]; }
    inline float& v3() { return m_data[3]; }
    inline const float& v4() const { return m_data[4]; }
    inline float& v4() { return m_data[4]; }
    inline const float& v5() const { return m_data[5]; }
    inline float& v5() { return m_data[5]; }
    inline const float& v6() const { return m_data[6]; }
    inline float& v6() { return m_data[6]; }
    inline const float& v7() const { return m_data[7]; }
    inline float& v7() { return m_data[7]; }
    inline const float& v8() const { return m_data[8]; }
    inline float& v8() { return m_data[8]; }
    ...
    inline void Set(const float* v) { memcpy(this, v, 36); }
    ...
    inline void Get(float* v) const { memcpy(v, this, 36); }
    ...
    inline void Get(
        AlignedVector3f& v0, AlignedVector3f& v1, AlignedVector3f& v2) const
    {
        Get012(v0);
        Get345(v1);
        Get678(v2);
    ...
    inline void MakeZero() { memset(this, 0, sizeof(AlignedVector9f)); }
    ...
    inline bool AssertEqual(const LA::AlignedVector9f& v, const int verbose = 1,
        const std::string str = "", const float epsAbs = 0.0f,
        const float epsRel = 0.0f) const
    {
        if (UT::VectorAssertEqual(
                &v0(), &v.v0(), 9, verbose, str, epsAbs, epsRel))
        {
            return true;
        }
        else if (verbose)
    ...
    static inline void apb(const AlignedVector9f& a, const AlignedVector9f& b,
        AlignedVector9f& apb)
    {
    ...
    static inline void amb(const AlignedVector9f& a, const AlignedVector9f& b,
        AlignedVector9f& amb)
    {
...
public:
    ...
    static inline Vector9<TYPE> Get(const float* v)
    {
        Vector9<TYPE> _v;
        _v.Set(v);
        return _v;
    ...
    inline const TYPE& v6() const { return m_data[6]; }
    inline TYPE& v6() { return m_data[6]; }
    inline const TYPE& v7() const { return m_data[7]; }
    inline TYPE& v7() { return m_data[7]; }
    inline const TYPE& v8() const { return m_data[8]; }
    inline TYPE& v8() { return m_data[8]; }

    inline operator const TYPE*() const { return m_data; }
    inline operator TYPE*() { return m_data; }
    // inline void operator = (const TYPE *v) { Set(v); }
    inline Vector9<TYPE> operator*(const TYPE s) const
    {
        Vector9<TYPE> v;
        GetScaled(s, v);
        return v;
    }
    inline Vector9<TYPE> operator*(const xp128f& s) const
    {
        Vector9<TYPE> v;
    ...
    inline Vector3<TYPE> Get012() const
    {
        Vector3<TYPE> v;
        Get012(v);
        return v;
    }
    inline Vector3<TYPE> Get345() const
    {
        Vector3<TYPE> v;
        Get345(v);
        return v;
    }
    inline Vector3<TYPE> Get678() const
    {
        Vector3<TYPE> v;
        Get678(v);
        return v;
    ...
    {
        return std::max(
            std::max(std::max(std::max(v0(), v1()), std::max(v2(), v3())),
                std::max(std::max(v4(), v5()), std::max(v6(), v7()))),
            v8());
    }
    ...
    inline bool AssertEqual(const Vector9<TYPE>& v, const int verbose = 1,
    ...
    static inline void AbTo0(
        const AlignedMatrix3x3f& A, const AlignedVector3f& b, Vector9<TYPE>& Ab)
    {
        Ab.v0() = (A.m_00_01_02_r0() * b.v012r()).vsum_012();
        Ab.v1() = (A.m_10_11_12_r1() * b.v012r()).vsum_012();
        Ab.v2() = (A.m_20_21_22_r2() * b.v012r()).vsum_012();
    }
    static inline void AddAbTo0(
        const AlignedMatrix3x3f& A, const AlignedVector3f& b, Vector9<TYPE>& Ab)
    {
        Ab.v0() += (A.m_00_01_02_r0() * b.v012r()).vsum_012();
        Ab.v1() += (A.m_10_11_12_r1() * b.v012r()).vsum_012();
...
template <> inline void Vector9f::Set(const float* v)
{
    memcpy(this, v, sizeof(Vector9f));
}
...
template <> inline void Vector9f::Set012(const float* v)
{
    memcpy(&v0(), v, 12);
}
template <> inline void Vector9f::Set345(const float* v)
{
    memcpy(&v3(), v, 12);
}
template <> inline void Vector9f::Set678(const float* v)
{
    memcpy(&v6(), v, 12);
}
...
template <> inline void Vector9f::Get012(float* v) const
{
    memcpy(v, &v0(), 12);
}
template <> inline void Vector9f::Get345(float* v) const
{
    memcpy(v, &v3(), 12);
}
template <> inline void Vector9f::Get678(float* v) const
{
    memcpy(v, &v6(), 12);
}
...
public:
    ...
    inline EigenVector9f(const Eigen::Matrix<float, 9, 1>& e_v)
        : Eigen::Matrix<float, 9, 1>(e_v)
    {
    }
    inline EigenVector9f(const float* v) : Eigen::Matrix<float, 9, 1>()
    {
        *this = v;
    }
    inline EigenVector9f(const LA::AlignedVector3f& v0,
    ...
    inline float SquaredLength() const
    {
        return GetAlignedVector9f().SquaredLength();
    }
    inline void Print(const bool e = false) const
    {
        GetAlignedVector9f().Print(e);
    }
    static inline EigenVector9f GetRandom(const float vMax)
    {
        return EigenVector9f(LA::AlignedVector9f::GetRandom(vMax));
    }
    inline bool AssertEqual(const LA::AlignedVector9f& v, const int verbose = 1,
        const std::string str = "", const float epsAbs = 0.0f,
        const float epsRel = 0.0f) const
    {
        return GetAlignedVector9f().AssertEqual(
            v, verbose, str, epsAbs, epsRel);
    }
    inline bool AssertEqual(const LA::Vector9f& v, const int verbose = 1,
        const std::string str = "", const float epsAbs = 0.0f,
        const float epsRel = 0.0f) const
    {
        return GetVector9f().AssertEqual(v, verbose, str, epsAbs, epsRel);
    }
    inline bool AssertEqual(const EigenVector9f& e_v, const int verbose = 1,
        const std::string str = "", const float epsAbs = 0.0f,
        const float epsRel = 0.0f) const
    {
        return AssertEqual(
            e_v.GetAlignedVector9f(), verbose, str, epsAbs, epsRel);
    }
    inline bool AssertZero(const int verbose = 1, const std::string str = "",
        const float epsAbs = 0.0f, const float epsRel = 0.0f) const
    {
