...
public:
    ...
    inline const xp128f& m_10_11_12_13() const { return m_data[1]; }
    inline xp128f& m_10_11_12_13() { return m_data[1]; }
    inline const xp128f& m_20_21_22_23() const { return m_data[2]; }
    inline xp128f& m_20_21_22_23() { return m_data[2]; }
    inline const xp128f& m_30_31_32_33() const { return m_data[3]; }
    inline xp128f& m_30_31_32_33() { return m_data[3]; }
    ...
    inline const float& m13() const { return m_data[1][3]; }
    inline float& m13() { return m_data[1][3]; }
    ...
    inline const float& m23() const { return m_data[2][3]; }
    inline float& m23() { return m_data[2][3]; }
    inline const float& m30() const { return m_data[3][0]; }
    inline float& m30() { return m_data[3][0]; }
    inline const float& m31() const { return m_data[3][1]; }
    inline float& m31() { return m_data[3][1]; }
    inline const float& m32() const { return m_data[3][2]; }
    inline float& m32() { return m_data[3][2]; }
    inline const float& m33() const { return m_data[3][3]; }
    inline float& m33() { return m_data[3][3]; }
...
public:
    ...
    static inline void AAT(
        const AlignedMatrix4x4f& A, SymmetricMatrix4x4<TYPE>& AAT);
...
public:
    ...
    static inline EigenVector4f Solve(
        const EigenMatrix4x4f& A, const EigenVector4f& b)
    {
    ...
    {
        return GetAlignedMatrix4x4f().AssertEqual(
    ...
    {
        return AssertEqual(
            e_M.GetAlignedMatrix4x4f(), verbose, str, epsAbs, epsRel);
    }
};
#endif
