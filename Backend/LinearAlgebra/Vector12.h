...
public:
    ...
    inline const float& v9() const { return m_data[9]; }
    inline float& v9() { return m_data[9]; }
    inline const float& v10() const { return m_data[10]; }
    inline float& v10() { return m_data[10]; }
    inline const float& v11() const { return m_data[11]; }
    inline float& v11() { return m_data[11]; }
