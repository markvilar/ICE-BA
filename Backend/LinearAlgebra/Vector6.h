...
{
public:
    static inline AlignedVector6f Get(const float* v)
    {
        AlignedVector6f _v;
        _v.Set(v);
        return _v;
    ...
    inline const xp128f& v45xx() const { return m_data4[1]; }
    inline xp128f& v45xx() { return m_data4[1]; }
    ...
    inline void Get345(AlignedVector3f& v) const
    {
        memcpy(&v, &this->v3(), 12);
    }
    ...
    inline void MakeZero012() { memset(this, 0, 12); }
        ...
        const float epsRel = 0.0f) const
    {
        if (UT::VectorAssertEqual(
                &v0(), &v.v0(), 6, verbose, str, epsAbs, epsRel))
        {
            return true;
        }
        else if (verbose)
...
public:
    static inline void apb(const AlignedVector6f& a, const AlignedVector6f& b,
        AlignedVector6f& apb)
    {
    ...
    static inline void AddsaTo(
        const float s, const AlignedVector6f& a, AlignedVector6f& sa)
    {
        sa.v0123() += a.v0123() * s;
        sa.v4() += a.v4() * s;
        sa.v5() += a.v5() * s;
...
public:
    static inline Vector6<TYPE> Get(const float* v)
    {
        Vector6<TYPE> _v;
        _v.Set(v);
        return _v;
    ...
    inline TYPE Maximal() const
    {
        ...
        return std::max(std::max(std::max(v0(), v1()), std::max(v2(), v3())),
            std::max(v4(), v5()));
    }
    ...
    static inline void AbTo0(
        const AlignedMatrix3x3f& A, const AlignedVector3f& b, Vector6<TYPE>& Ab)
    {
...
template <> inline void Vector6f::Set(const float* v)
{
    memcpy(this, v, sizeof(Vector6f));
}
template <> inline void Vector6f::Set012(const float* v)
{
    memcpy(&v0(), v, 12);
}
template <> inline void Vector6f::Set345(const float* v)
{
    memcpy(&v3(), v, 12);
}
// TODO (yanghongtian) : check this operation.
template <> inline void Vector6f::Get012(float* v) const
{
    memcpy(v, &v0(), 12);
}
template <> inline void Vector6f::Get345(float* v) const
{
    memcpy(v, &v3(), 12);
}
...
template <> inline void Vector6d::Set(const double* v)
{
    memcpy(this, v, sizeof(Vector6d));
}
...
public:
    ...
    inline const xp128f& v4501() const { return v45xx(); }
    inline xp128f& v4501() { return v45xx(); }
    inline const xp128f& v2345() const { return m_v2345; }
    inline xp128f& v2345() { return m_v2345; }

    inline void Set(const float* v)
    {
        LA::AlignedVector6f::Set(v);
        Update();
    }
    inline void Set(const double* v)
    {
    ...
    inline void Update() { memcpy(&m_data4[1][2], &v0(), 24); }
...
public:
    ...
    inline EigenVector6f(const float* v) : Eigen::Matrix<float, 6, 1>()
    {
        *this = v;
    }
    ...
    inline EigenVector6f(
        const LA::AlignedVector3f& v0, const LA::AlignedVector3f& v1)
    {
    ...
    inline bool AssertEqual(const LA::AlignedVector6f& v, const int verbose = 1,
        ...
        const float epsRel = 0.0f) const
    {
        return GetAlignedVector6f().AssertEqual(
    ...
    {
        return AssertEqual(
            e_v.GetAlignedVector6f(), verbose, str, epsAbs, epsRel);
    }
    inline bool AssertZero(const int verbose = 1, const std::string str = "",
        const float epsAbs = 0.0f, const float epsRel = 0.0f) const
    {
