...
public:
    ...
    inline const xp128f& m_04_05_06_x() const { return m_data[1]; }
    inline xp128f& m_04_05_06_x() { return m_data[1]; }
    inline const xp128f& m_10_11_12_13() const { return m_data[2]; }
    inline xp128f& m_10_11_12_13() { return m_data[2]; }
    inline const xp128f& m_14_15_16_x() const { return m_data[3]; }
    inline xp128f& m_14_15_16_x() { return m_data[3]; }
    inline const xp128f& m_20_21_22_23() const { return m_data[4]; }
    inline xp128f& m_20_21_22_23() { return m_data[4]; }
    inline const xp128f& m_24_25_26_x() const { return m_data[5]; }
    inline xp128f& m_24_25_26_x() { return m_data[5]; }
    inline const xp128f& m_30_31_32_33() const { return m_data[6]; }
    inline xp128f& m_30_31_32_33() { return m_data[6]; }
    inline const xp128f& m_34_35_36_x() const { return m_data[7]; }
    inline xp128f& m_34_35_36_x() { return m_data[7]; }
    inline const xp128f& m_40_41_42_43() const { return m_data[8]; }
    inline xp128f& m_40_41_42_43() { return m_data[8]; }
    inline const xp128f& m_44_45_46_x() const { return m_data[9]; }
    inline xp128f& m_44_45_46_x() { return m_data[9]; }
    inline const xp128f& m_50_51_52_53() const { return m_data[10]; }
    inline xp128f& m_50_51_52_53() { return m_data[10]; }
    inline const xp128f& m_54_55_56_x() const { return m_data[11]; }
    inline xp128f& m_54_55_56_x() { return m_data[11]; }
    ...
    inline float& operator()(int row, int col) { return data[row * 7 + col]; }
    ...
    static inline void AddABToSymmetric(const AlignedMatrix3x3f& A0,
        const AlignedMatrix3x3f& A1, const AlignedMatrix3x7f& B,
        AlignedMatrix6x7f& AB)
    {
        ...
        t2 = A0.m01();
        t3 = A0.m02();
        AB.m_00_01_02_03() += B.m_00_01_02_03() * t1 + B.m_10_11_12_13() * t2 +
                              B.m_20_21_22_23() * t3;

        AB.m_04_05_06_x() += B.m_04_05_06_x() * t1 + B.m_14_15_16_x() * t2 +
                             B.m_24_25_26_x() * t3;
        t1 = A0.m10();
        t2 = A0.m11();
        t3 = A0.m12();
        AB.m_10_11_12_13() += B.m_00_01_02_03() * t1 + B.m_10_11_12_13() * t2 +
                              B.m_20_21_22_23() * t3;

        AB.m_14_15_16_x() += B.m_04_05_06_x() * t1 + B.m_14_15_16_x() * t2 +
                             B.m_24_25_26_x() * t3;
        ...
        AB.m_24_25_26_x() += B.m_04_05_06_x() * A0.m20() +
                             B.m_14_15_16_x() * A0.m21() +
                             B.m_24_25_26_x() * A0.m22();

        AB.m33() += (A1.m_00_01_02_r0() * tmp).vsum_012();
        AB.m_34_35_36_x() += B.m_04_05_06_x() * A1.m00() +
                             B.m_14_15_16_x() * A1.m01() +
                             B.m_24_25_26_x() * A1.m02();
        AB.m_44_45_46_x() += B.m_04_05_06_x() * A1.m10() +
                             B.m_14_15_16_x() * A1.m11() +
                             B.m_24_25_26_x() * A1.m12();
    ...
    static inline void ATBToSymmetric(const AlignedMatrix3x6f& A,
        const AlignedMatrix3x7f& B, AlignedMatrix6x7f& ATB)
    {
        xp128f a0, a1, a2;
        a0.vdup_all_lane(A.m00());
        a1.vdup_all_lane(A.m10());
        a2.vdup_all_lane(A.m20());
        ATB.m_00_01_02_03() = B.m_00_01_02_03() * a0 + B.m_10_11_12_13() * a1 +
                              B.m_20_21_22_23() * a2;
        ATB.m_04_05_06_x() = B.m_04_05_06_x() * a0 + B.m_14_15_16_x() * a1 +
                             B.m_24_25_26_x() * a2;
        a0.vdup_all_lane(A.m01());
        a1.vdup_all_lane(A.m11());
        a2.vdup_all_lane(A.m21());
        ATB.m_10_11_12_13() = B.m_00_01_02_03() * a0 + B.m_10_11_12_13() * a1 +
                              B.m_20_21_22_23() * a2;
        ATB.m_14_15_16_x() = B.m_04_05_06_x() * a0 + B.m_14_15_16_x() * a1 +
                             B.m_24_25_26_x() * a2;
        ATB.m22() = A.m02() * B.m02() + A.m12() * B.m12() + A.m22() * B.m22();
        ATB.m23() = A.m02() * B.m03() + A.m12() * B.m13() + A.m22() * B.m23();

        ATB.m_24_25_26_x() = B.m_04_05_06_x() * A.m02() +
                             B.m_14_15_16_x() * A.m12() +
                             B.m_24_25_26_x() * A.m22();
        ATB.m33() = A.m03() * B.m03() + A.m13() * B.m13() + A.m23() * B.m23();
        ATB.m_34_35_36_x() = B.m_04_05_06_x() * A.m03() +
                             B.m_14_15_16_x() * A.m13() +
                             B.m_24_25_26_x() * A.m23();
        ATB.m_44_45_46_x() = B.m_04_05_06_x() * A.m04() +
                             B.m_14_15_16_x() * A.m14() +
                             B.m_24_25_26_x() * A.m24();
    ...
    static inline void AddABTToSymmetric00(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B0, const AlignedVector3f& b1,
    ...
    static inline void SubtractABTFromSymmetric(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B0, const AlignedMatrix3x3f& B1,
        const AlignedVector3f& b2, AlignedMatrix6x7f& ABT)
    {
        ABT.m00() -= (A.m_00_01_02_r0() * B0.m_00_01_02_r0()).vsum_012();
        ABT.m01() -= (A.m_00_01_02_r0() * B0.m_10_11_12_r1()).vsum_012();
        ABT.m02() -= (A.m_00_01_02_r0() * B0.m_20_21_22_r2()).vsum_012();
    ...
    inline bool AssertEqual(const AlignedMatrix6x7f& M, const int verbose = 1,
        const std::string str = "", const float epsAbs = 0.0f,
        const float epsRel = 0.0f) const
    {
        if (UT::VectorAssertEqual(
                &m00(), &M.m00(), 7, verbose, str, epsAbs, epsRel) &&
            UT::VectorAssertEqual(
                &m10(), &M.m10(), 7, verbose, str, epsAbs, epsRel) &&
            UT::VectorAssertEqual(
                &m20(), &M.m20(), 7, verbose, str, epsAbs, epsRel) &&
            UT::VectorAssertEqual(
                &m30(), &M.m30(), 7, verbose, str, epsAbs, epsRel) &&
            UT::VectorAssertEqual(
                &m40(), &M.m40(), 7, verbose, str, epsAbs, epsRel) &&
            UT::VectorAssertEqual(
                &m50(), &M.m50(), 7, verbose, str, epsAbs, epsRel))
        {
            return true;
        }
        else if (verbose)
...
public:
    ...
    {
        if (UT::VectorAssertEqual<TYPE>(
                m_data, A.m_data, 27, verbose, str, epsAbs, epsRel))
        {
            return true;
        }
        else if (verbose)
...
public:
    ...
    inline EigenMatrix6x7f(const EigenMatrix3x3f& e_M00,
        const EigenMatrix3x3f& e_M01, const EigenVector3f& e_m02,
    ...
    {
        return GetAlignedMatrix6x7f().AssertEqual(
            M, verbose, str, epsAbs, epsRel);
    }
    inline bool AssertEqual(const EigenMatrix6x7f& e_M, const int verbose = 1,
        const std::string str = "", const float epsAbs = 0.0f,
        const float epsRel = 0.0f) const
    {
        return AssertEqual(
            e_M.GetAlignedMatrix6x7f(), verbose, str, epsAbs, epsRel);
    }
};
#endif
