...
{
public:
    inline const xp128f& m_00_01_02_r0() const { return m_data[0]; }
    inline xp128f& m_00_01_02_r0() { return m_data[0]; }
    inline const xp128f& m_10_11_12_r1() const { return m_data[1]; }
    inline xp128f& m_10_11_12_r1() { return m_data[1]; }
    inline const xp128f& m_20_21_22_r2() const { return m_data[2]; }
    inline xp128f& m_20_21_22_r2() { return m_data[2]; }
    ...
    {
        AlignedMatrix3x3f _ApB;
        ApB(*this, B, _ApB);
        return _ApB;
    }
    inline AlignedMatrix3x3f operator-(const AlignedMatrix3x3f& B) const
    {
        AlignedMatrix3x3f _AmB;
        AmB(*this, B, _AmB);
        return _AmB;
    }
    ...
    inline void SetColumn0(const float* v)
    {
        m00() = v[0];
        m10() = v[1];
        m20() = v[2];
    }
    inline void SetColumn1(const float* v)
    {
        m01() = v[0];
        m11() = v[1];
        m21() = v[2];
    }
    inline void SetColumn2(const float* v)
    {
        m02() = v[0];
        m12() = v[1];
        m22() = v[2];
    ...
    inline bool GetInverseLDL(
        AlignedMatrix3x3f& MI, const float* eps = NULL) const
    {
        MI = *this;
    ...
    inline float SquaredFrobeniusNorm() const
    {
        return (m_00_01_02_r0() * m_00_01_02_r0() +
                ...
                m_20_21_22_r2() * m_20_21_22_r2())
            .vsum_012();
    }
    inline void EnforceUnitFrobeniusNorm()
    {
        Scale(sqrtf(1.0f / SquaredFrobeniusNorm()));
    }
        ...
        const float epsRel = 0.0f) const
    {
        if (UT::VectorAssertEqual(
                &m00(), &M.m00(), 3, verbose, str, epsAbs, epsRel) &&
            UT::VectorAssertEqual(
                &m10(), &M.m10(), 3, verbose, str, epsAbs, epsRel) &&
            UT::VectorAssertEqual(
                &m20(), &M.m20(), 3, verbose, str, epsAbs, epsRel))
        {
            return true;
        }
        else if (verbose)
    ...
    static inline AlignedMatrix3x3f GetRandom(
    ...
    {
        const xp128f t = B.m_00_01_02_r0() * a[0] + B.m_10_11_12_r1() * a[1] +
                         B.m_20_21_22_r2() * a[2];
        memcpy(a, &t, 12);
    }
    ...
    static inline void AddsATo(const xp128f& s, const AlignedMatrix3x3f& A,
        AlignedMatrix3x3f& sA, const bool symmetric)
    {
        if (symmetric)
        {
            AddsAToUpper(s, A, sA);
    ...
    static inline void Ab_simd(
        const AlignedMatrix3x3f& A, const AlignedVector3f& b, float* Ab)
    {
    ...
    static inline void Ab(
        const AlignedMatrix3x3f& A, const AlignedVector3f& b, TYPE* Ab)
    {
        const float *Ar0 = &A.m00(), *Ar1 = &A.m10(), *Ar2 = &A.m20();
        const float* br = b;
        Ab[0] = *(Ar0 + 0) * *(br + 0) + *(Ar0 + 1) * *(br + 1) +
                *(Ar0 + 2) * *(br + 2);
        Ab[1] = *(Ar1 + 0) * *(br + 0) + *(Ar1 + 1) * *(br + 1) +
                *(Ar1 + 2) * *(br + 2);
        Ab[2] = *(Ar2 + 0) * *(br + 0) + *(Ar2 + 1) * *(br + 1) +
                *(Ar2 + 2) * *(br + 2);
    }

    static inline void AddAbTo_simd(
        const AlignedMatrix3x3f& A, const AlignedVector3f& b, float* Ab)
    {
        Ab[0] += (A.m_00_01_02_r0() * b.v012r()).vsum_012();
        Ab[1] += (A.m_10_11_12_r1() * b.v012r()).vsum_012();
    ...
    static inline void ApB(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B, AlignedMatrix3x3f& ApB)
    {
    ...
    static inline void AmB(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B, AlignedMatrix3x3f& AmB)
    {
    ...
    // this is confusing, fucntion name AB means C = A * B, but in fact, it's A
    // * BT
    ...
    static inline void ABT_simd(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B, AlignedMatrix3x3f& ABT)
    {
        ABT.m00() = (A.m_00_01_02_r0() * B.m_00_01_02_r0()).vsum_012();
        ABT.m01() = (A.m_00_01_02_r0() * B.m_10_11_12_r1()).vsum_012();
    ...
    static inline void ABT(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B, float* ABT0, float* ABT1, float* ABT2)
    {
    ...
    static inline void ABTToUpper(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B, AlignedMatrix3x3f& ABT)
    {
        ABT.m00() = (A.m_00_01_02_r0() * B.m_00_01_02_r0()).vsum_012();
        ABT.m01() = (A.m_00_01_02_r0() * B.m_10_11_12_r1()).vsum_012();
    ...
    static inline void AddABTToUpper(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B, AlignedMatrix3x3f& ABT)
    {
        ABT.m00() += (A.m_00_01_02_r0() * B.m_00_01_02_r0()).vsum_012();
        ABT.m01() += (A.m_00_01_02_r0() * B.m_10_11_12_r1()).vsum_012();
    ...
    static inline void SubtractABTFrom(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B, AlignedMatrix3x3f& ABT)
    {
        ABT.m00() -= (A.m_00_01_02_r0() * B.m_00_01_02_r0()).vsum_012();
        ABT.m01() -= (A.m_00_01_02_r0() * B.m_10_11_12_r1()).vsum_012();
    ...
    static inline void SubtractABTFromUpper(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B, AlignedMatrix3x3f& ABT)
    {
        ABT.m00() -= (A.m_00_01_02_r0() * B.m_00_01_02_r0()).vsum_012();
        ABT.m01() -= (A.m_00_01_02_r0() * B.m_10_11_12_r1()).vsum_012();
    ...
    static inline void AddABTTo_simd(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B, AlignedMatrix3x3f& ABT)
    {
        ABT.m00() += (A.m_00_01_02_r0() * B.m_00_01_02_r0()).vsum_012();
        ABT.m01() += (A.m_00_01_02_r0() * B.m_10_11_12_r1()).vsum_012();
    ...
    static inline AlignedMatrix3x3f GetABT(
        const AlignedMatrix3x3f& A, const AlignedMatrix3x3f& B)
    {
    ...
    static inline void AddATBTo(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B, AlignedMatrix3x3f& ATB)
    {
        ATB.m_00_01_02_r0() += B.m_00_01_02_r0() * A.m00() +
                               B.m_10_11_12_r1() * A.m10() +
    ...
    static inline void SubtractATBFrom(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B, AlignedMatrix3x3f& ATB)
    {
        ATB.m_00_01_02_r0() -= B.m_00_01_02_r0() * A.m00() +
                               B.m_10_11_12_r1() * A.m10() +
    ...
    template <typename TYPE>
    static inline LA::AlignedVector3f GetATb(
        const AlignedMatrix3x3f& A, const Vector2<TYPE>& b)
    {
...
public:
    ...
    inline const TYPE& m00() const { return m_data[0][0]; }
    inline TYPE& m00() { return m_data[0][0]; }
    inline const TYPE& m01() const { return m_data[0][1]; }
    inline TYPE& m01() { return m_data[0][1]; }
    inline const TYPE& m02() const { return m_data[0][2]; }
    inline TYPE& m02() { return m_data[0][2]; }
    inline const TYPE& m10() const { return m_data[1][0]; }
    inline TYPE& m10() { return m_data[1][0]; }
    inline const TYPE& m11() const { return m_data[1][1]; }
    inline TYPE& m11() { return m_data[1][1]; }
    inline const TYPE& m12() const { return m_data[1][2]; }
    inline TYPE& m12() { return m_data[1][2]; }
    inline const TYPE& m20() const { return m_data[2][0]; }
    inline TYPE& m20() { return m_data[2][0]; }
    inline const TYPE& m21() const { return m_data[2][1]; }
    inline TYPE& m21() { return m_data[2][1]; }
    inline const TYPE& m22() const { return m_data[2][2]; }
    inline TYPE& m22() { return m_data[2][2]; }
...
public:
    ...
    inline TYPE& m10() { return m_data[1]; }
    ...
    inline const TYPE& m20() const { return m_data[2]; }
    inline TYPE& m20() { return m_data[2]; }
    inline const TYPE& m21() const { return m_data[4]; }
    inline TYPE& m21() { return m_data[4]; }
    ...
    {
        M.m_00_01_02_r0().vset_all_lane(static_cast<float>(m00()),
            static_cast<float>(m01()),
            static_cast<float>(m02()),
            0.0f);
        M.m_10_11_12_r1().vset_all_lane(static_cast<float>(m01()),
            static_cast<float>(m11()),
            static_cast<float>(m12()),
            0.0f);
        M.m_20_21_22_r2().vset_all_lane(static_cast<float>(m02()),
            static_cast<float>(m12()),
    ...
    inline void IncreaseDiagonal(
        const SymmetricMatrix2x2<TYPE>& D0, const TYPE d1)
    {
        m00() += D0.m00();
        m01() += D0.m01();
        m11() += D0.m11();
    ...
    inline bool GetInverse(
        AlignedMatrix3x3f& MI, const TYPE mMax = 0, const TYPE eps = 0) const
    {
        ...
        else
        {
            ...
            if (eps > 0 && (fabs(m00() * MI.m00() + m01() * MI.m10() +
                                 m02() * MI.m20() - 1) > eps ||
                               fabs(m00() * MI.m01() + m01() * MI.m11() +
                                    m02() * MI.m21()) > eps ||
                               fabs(m00() * MI.m02() + m01() * MI.m12() +
                                    m02() * MI.m22()) > eps ||
                               fabs(m10() * MI.m01() + m11() * MI.m11() +
                                    m12() * MI.m21() - 1) > eps ||
                               fabs(m10() * MI.m02() + m11() * MI.m12() +
                                    m12() * MI.m22()) > eps ||
                               fabs(m20() * MI.m02() + m21() * MI.m12() +
                                    m22() * MI.m22() - 1) > eps))
            {
                MI.Invalidate();
                return false;
    ...
    static inline float MahalanobisDistance(
        const AlignedMatrix3x3f& W, const AlignedVector3f& d)
    {
#ifdef CFG_DEBUG
        W.AssertSymmetric();
#endif
    ...
    static inline TYPE MahalanobisDistance(const SymmetricMatrix3x3<TYPE>& W,
        const Vector2<TYPE>& d0, const TYPE d1)
    {
    ...
    static inline TYPE MahalanobisDistance(
        const SymmetricMatrix3x3<TYPE>& W, const Vector2<TYPE>& d)
    {
        return (W.m00() * d.v0() + W.m01() * d.v1()) * d.v0() +
               (W.m01() * d.v0() + W.m11() * d.v1()) * d.v1();
    }

    static inline void AddATo(
        const SymmetricMatrix3x3<TYPE>& A, AlignedMatrix3x3f& SA)
    {
        SA.m00() += A.m00();
        SA.m01() += A.m01();
        SA.m02() += A.m02();
    ...
    static inline void aaT(
        const Vector2<TYPE>& a0, const TYPE a1, SymmetricMatrix3x3<TYPE>& aaT)
    {
        aaT.m00() = a0.v0() * a0.v0();
        aaT.m01() = a0.v0() * a0.v1();
        aaT.m02() = a0.v0() * a1;
    ...
    static inline void AAT(
        const AlignedMatrix3x3f& A, SymmetricMatrix3x3<TYPE>& AAT)
    {
    ...
    static inline void ABT(const AlignedMatrix3x3f& A,
        const AlignedMatrix3x3f& B, SymmetricMatrix3x3<TYPE>& ABT)
    {
        ABT.m00() = (A.m_00_01_02_r0() * B.m_00_01_02_r0()).vsum_012();
        ABT.m01() = (A.m_00_01_02_r0() * B.m_10_11_12_r1()).vsum_012();
        ABT.m02() = (A.m_00_01_02_r0() * B.m_20_21_22_r2()).vsum_012();
    ...
    static inline void ApB(const SymmetricMatrix3x3<TYPE>& A,
        const SymmetricMatrix3x3<TYPE>& B, SymmetricMatrix3x3<TYPE>& ApB)
    {
        ApB.m00() = A.m00() + B.m00();
        ApB.m01() = A.m01() + B.m01();
        ApB.m02() = A.m02() + B.m02();
...
template <> inline void SymmetricMatrix3x3f::SetRow0(const xp128f& v)
{
    memcpy(&m00(), &v, 12);
}
template <> inline void SymmetricMatrix3x3f::Get(SymmetricMatrix3x3f& M) const
{
    M = *this;
}
...
template <> inline void SymmetricMatrix3x3d::Get(SymmetricMatrix3x3d& M) const
{
    M = *this;
}
template <>
...
public:
    ...
    explicit inline EigenMatrix3x3f(const Eigen::Matrix3f& e_M)
        : Eigen::Matrix3f(e_M)
    {
    }
    explicit inline EigenMatrix3x3f(const LA::AlignedMatrix3x3f& M)
        : Eigen::Matrix3f()
    {
    ...
    explicit inline EigenMatrix3x3f(const LA::SymmetricMatrix3x3f& M)
        : Eigen::Matrix3f()
    {
        Eigen::Matrix3f& e_M = *this;
        e_M(0, 0) = M.m00();
    ...
    inline EigenMatrix3x3f(const float m0, const float m1, const float m2)
        : Eigen::Matrix3f()
    {
        Eigen::Matrix3f& e_M = *this;
        e_M.setZero();
    ...
    inline bool AssertEqual(const EigenMatrix3x3f& e_M, const int verbose = 1,
        const std::string str = "", const float epsAbs = 0.0f,
        const float epsRel = 0.0f) const
    {
        return AssertEqual(
            e_M.GetAlignedMatrix3x3f(), verbose, str, epsAbs, epsRel);
    }
    inline bool AssertZero(const int verbose = 1, const std::string str = "",
        const float epsAbs = 0.0f, const float epsRel = 0.0f) const
    {
