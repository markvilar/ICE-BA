...
public:
    ...
    inline bool AssertEqual(const AlignedMatrix2x3f& M, const int verbose = 1,
    ...
    static inline AlignedMatrix2x3f GetRandom(
    ...
    static inline void Ab(
        const AlignedMatrix2x3f& A, const AlignedVector3f& b, float* Ab)
    {
    ...
    static inline void AB(const SymmetricMatrix2x2f& A,
        const AlignedMatrix2x3f& B, AlignedMatrix2x3f& AB)
    {
        const xp128f a01 = xp128f::get(A.m01());
        AB.m_00_01_02_r0() =
            B.m_00_01_02_r0() * A.m00() + B.m_10_11_12_r1() * a01;
        AB.m_10_11_12_r1() =
            B.m_00_01_02_r0() * a01 + B.m_10_11_12_r1() * A.m11();
    }
    // static inline void AB(const SymmetricMatrix2x2f &A, const
    // AlignedMatrix2x3f &B1,
    //                      const AlignedMatrix2x3f &B2,
    //                      AlignedMatrix2x3f &AB1, AlignedMatrix2x3f &AB2) {
    //  AB1.m_00_01_02_r0() = B1.m_00_01_02_r0() * A.m00() + B1.m_10_11_12_r1()
    //  * A.m01(); AB1.m_10_11_12_r1() = B1.m_00_01_02_r0() * A.m01() +
    //  B1.m_10_11_12_r1() * A.m11(); AB2.m_00_01_02_r0() = B2.m_00_01_02_r0() *
    //  A.m00() + B2.m_10_11_12_r1() * A.m01(); AB2.m_10_11_12_r1() =
    //  B2.m_00_01_02_r0() * A.m01() + B2.m_10_11_12_r1() * A.m11();
    //}
    static inline void ABT(const AlignedMatrix2x3f& A,
        const AlignedMatrix2x3f& B, SymmetricMatrix2x2f& ABT)
    {
    ...
    static inline void AddABTTo(const AlignedMatrix2x3f& A,
        const AlignedMatrix2x3f& B, SymmetricMatrix2x2f& ABT)
    {
        ABT.m00() += (A.m_00_01_02_r0() * B.m_00_01_02_r0()).vsum_012();
        ABT.m01() += (A.m_00_01_02_r0() * B.m_10_11_12_r1()).vsum_012();
    ...
    static inline void ABT(const AlignedMatrix2x3f& A,
        const AlignedMatrix3x3f& B, AlignedMatrix2x3f& ABT)
    {
        ABT.m00() = (A.m_00_01_02_r0() * B.m_00_01_02_r0()).vsum_012();
        ABT.m01() = (A.m_00_01_02_r0() * B.m_10_11_12_r1()).vsum_012();
    ...
    static inline void ATB(const AlignedMatrix2x3f& A,
        const AlignedMatrix2x3f& B, AlignedMatrix3x3f& ATB)
    {
        ATB.m_00_01_02_r0() =
            B.m_00_01_02_r0() * A.m00() + B.m_10_11_12_r1() * A.m10();
        ATB.m_10_11_12_r1() =
            B.m_00_01_02_r0() * A.m01() + B.m_10_11_12_r1() * A.m11();
        ATB.m_20_21_22_r2() =
            B.m_00_01_02_r0() * A.m02() + B.m_10_11_12_r1() * A.m12();
    }
    static inline void ATBToUpper(const AlignedMatrix2x3f& A,
        const AlignedMatrix2x3f& B, AlignedMatrix3x3f& ATB)
    {
        ATB.m_00_01_02_r0() =
            B.m_00_01_02_r0() * A.m00() + B.m_10_11_12_r1() * A.m10();
    ...
    static inline void ATb(
        const AlignedMatrix2x3f& A, const Vector2f& b, AlignedVector3f& ATb)
    {
    ...
    static inline void ATb(const AlignedMatrix2x3f& A, const xp128f& b0,
        const xp128f& b1, AlignedVector3f& ATb)
    {
        ATb.v012r() = A.m_00_01_02_r0() * b0 + A.m_10_11_12_r1() * b1;
    }
    static inline void AddATbTo(const AlignedMatrix2x3f& A, const xp128f& b0,
        const xp128f& b1, AlignedVector3f& ATb)
    {
        ATb.v012r() += A.m_00_01_02_r0() * b0 + A.m_10_11_12_r1() * b1;
    }
...
public:
    ...
    static inline void AddAbTo(
        const Matrix2x3<TYPE>& A, const AlignedVector3f& b, float* Ab)
    {
...
public:
    ...
    inline bool AssertEqual(const LA::AlignedMatrix2x3f& M,
        ...
        const float epsAbs = 0.0f, const float epsRel = 0.0f) const
    {
        return GetAlignedMatrix2x3f().AssertEqual(
            M, verbose, str, epsAbs, epsRel);
    }
    inline bool AssertEqual(const EigenMatrix2x3f& e_M, const int verbose = 1,
        const std::string str = "", const float epsAbs = 0.0f,
        const float epsRel = 0.0f) const
    {
        return AssertEqual(
            e_M.GetAlignedMatrix2x3f(), verbose, str, epsAbs, epsRel);
    }
};
#endif
