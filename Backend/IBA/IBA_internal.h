...
public:
    ...
    public:
        ...
        {
            return m_iFrm < idx.m_iFrm ||
                   (m_iFrm == idx.m_iFrm && m_idx < idx.m_idx);
        }
...
protected:
    ...
    const GlobalMap::InputKeyFrame& PushKeyFrame(
        const KeyFrame& KF, const Camera* C = NULL);
    void ConvertFeatureMeasurements(
