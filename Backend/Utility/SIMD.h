...
template <class T> class vector : public std::vector<T, aligned_allocator<T>>
{
};
...
inline void Multiply(const int i, const int N, const xp128f& a, float* Vb)
{
    ...
    case 4:
        ...
        break;
    case 5:
        Multiply<1>(N - 4, a, Vb + 4);
        break;
    case 6:
        Multiply<2>(N - 4, a, Vb + 4);
        break;
    default:
    {
...
inline void MultiplyAddTo(
    const int i, const int N, const xp128f& a, const float* Vb, float* Vab)
{
    switch (i)
    {
    case 0:
        MultiplyAddTo<0>(N, a, Vb, Vab);
        break;
    case 1:
        MultiplyAddTo<1>(N, a, Vb, Vab);
        break;
    case 2:
        MultiplyAddTo<2>(N, a, Vb, Vab);
        break;
    case 3:
        MultiplyAddTo<3>(N, a, Vb, Vab);
        break;
    case 4:
        MultiplyAddTo<0>(N - 4, a, Vb + 4, Vab + 4);
        break;
    case 5:
        MultiplyAddTo<1>(N - 4, a, Vb + 4, Vab + 4);
        break;
    case 6:
        MultiplyAddTo<2>(N - 4, a, Vb + 4, Vab + 4);
        break;
    default:
    {
        const int NF = SIMD_FLOAT_FLOOR(i);
...
inline void Inverse(const int N, float* V, const float s = 1.0f,
    const bool chkZero = false, const float eps = 0.0f)
{
...
inline float Dot(const int i, const int N, const float* Va, const float* Vb)
{
    ...
    {
    case 0:
        return Dot<0>(N, Va, Vb);
    case 1:
        return Dot<1>(N, Va, Vb);
    case 2:
        return Dot<2>(N, Va, Vb);
    case 3:
        return Dot<3>(N, Va, Vb);
    case 4:
        return Dot<0>(N - 4, Va + 4, Vb + 4);
    case 5:
        return Dot<1>(N - 4, Va + 4, Vb + 4);
    case 6:
        return Dot<2>(N - 4, Va + 4, Vb + 4);
    default:
    {
        const int NF = SIMD_FLOAT_FLOOR(i);
