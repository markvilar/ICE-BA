...
public:
    ...
    public:
        ...
        public:
            ...
            {
            public:
                static inline CC Get(
                    const LA::SymmetricMatrix6x6f& A, const LA::Vector6f& b)
                {
                    CC _A;
                    _A.Set(A, b);
                    return _A;
                ...
                inline void Set(const LA::AlignedMatrix6x6f& A,
                    const LA::AlignedVector6f& b)
                {
                    m_A.Set(A);
                    m_b.Set(b);
                }
                inline void Set(const LA::AlignedMatrix3x3f& App,
                    const LA::AlignedMatrix3x3f& Apr,
                    const LA::AlignedMatrix3x3f& Arr,
                    const LA::AlignedVector3f& bp,
                ...
                inline void Increase3(
                    const LA::SymmetricMatrix3x3f& A, const LA::Vector3f& b)
                {
                    m_A.Increase33(A);
                    m_b.Increase345(b);
                }
                ...
                inline void Print(
                    const bool e = false, const bool f = false) const
                {
                    m_A.Print(e, f);
                    m_b.Print(e);
                }

                inline void PrintError(const CC& A, const bool e = false,
                    const bool f = false) const
                {
                    UT::PrintSeparator();
                    Print(e, f);
                    UT::PrintSeparator();
                ...
                inline bool AssertEqual(const CC& A, const int verbose = 1,
                    ...
                    const float epsRel = 0.0f) const
                {
                    ...
                    const LA::AlignedMatrix6x6f A2 =
                        A.m_A.GetAlignedMatrix6x6f();
                    A1.Get00(App1);
                    A1.Get03(Apr1);
                    A1.Get33(Arr1);
                    A2.Get00(App2);
                    ...
                    b2.Get345(br2);
                    bool scc = true;
                    scc = App1.AssertEqual(
                              App2, verbose, str + ".m_App", epsAbs, epsRel) &&
                          scc;
                    scc = Apr1.AssertEqual(
                              Apr2, verbose, str + ".m_Apr", epsAbs, epsRel) &&
                          scc;
                    scc = Arr1.AssertEqual(
                              Arr2, verbose, str + ".m_Arr", epsAbs, epsRel) &&
                          scc;
                    scc = bp1.AssertEqual(
                              bp2, verbose, str + ".m_bp", epsAbs, epsRel) &&
                          scc;
                    scc = br1.AssertEqual(
                              br2, verbose, str + ".m_br", epsAbs, epsRel) &&
                          scc;
                    if (scc)
                    {
                        return true;
                ...
                {
                    return m_A.AssertZero(
                               verbose, str + ".m_A", -1.0f, -1.0f) &&
            ...
            public:
                ...
                inline bool AssertEqual(const CM& A, const int verbose = 1,
                    const std::string str = "", const float epsAbs = 0.0f,
                    const float epsRel = 0.0f) const
                {
                    LA::AlignedMatrix3x3f Apv1, Apba1, Apbw1, Arv1, Arba1,
                        Arbw1;
                    LA::AlignedMatrix3x3f Apv2, Apba2, Apbw2, Arv2, Arba2,
                        Arbw2;
                    const LA::AlignedMatrix6x9f& A1 = *this;
                    const LA::AlignedMatrix6x9f& A2 = A;
                    A1.GetBlock(0, 0, Apv1);
                    A2.GetBlock(0, 0, Apv2);
                    A1.GetBlock(0, 3, Apba1);
                    A2.GetBlock(0, 3, Apba2);
                    A1.GetBlock(0, 6, Apbw1);
                    A2.GetBlock(0, 6, Apbw2);
                    A1.GetBlock(3, 0, Arv1);
                    A2.GetBlock(3, 0, Arv2);
                    A1.GetBlock(3, 3, Arba1);
                    A2.GetBlock(3, 3, Arba2);
                    A1.GetBlock(3, 6, Arbw1);
                    A2.GetBlock(3, 6, Arbw2);
                    bool scc = true;
                    scc = Apv1.AssertEqual(
                              Apv2, verbose, str + ".m_Apv", epsAbs, epsRel) &&
                          scc;
                    scc =
                        Apba1.AssertEqual(
                            Apba2, verbose, str + ".m_Apba", epsAbs, epsRel) &&
                        scc;
                    scc =
                        Apbw1.AssertEqual(
                            Apbw2, verbose, str + ".m_Apbw", epsAbs, epsRel) &&
                        scc;
                    scc = Arv1.AssertEqual(
                              Arv2, verbose, str + ".m_Arv", epsAbs, epsRel) &&
                          scc;
                    scc =
                        Arba1.AssertEqual(
                            Arba2, verbose, str + ".m_Arba", epsAbs, epsRel) &&
                        scc;
                    scc =
                        Arbw1.AssertEqual(
                            Arbw2, verbose, str + ".m_Arbw", epsAbs, epsRel) &&
                        scc;
                    if (scc)
                    {
                        return true;
            ...
            public:
                ...
                inline void Get(
                    LA::AlignedMatrix9x9f* A, LA::AlignedVector9f* b) const
                {
                    A->Set(m_A);
                    b->Set(m_b);
                }
                ...
                inline bool AssertEqual(const MM& A, const int verbose = 1,
                    const std::string str = "", const float epsAbs = 0.0f,
                    const float epsRel = 0.0f) const
                {
                    LA::AlignedMatrix3x3f Avv1, Avba1, Avbw1, Ababa1, Ababw1,
                        Abwbw1;
                    LA::AlignedMatrix3x3f Avv2, Avba2, Avbw2, Ababa2, Ababw2,
                        Abwbw2;
                    ...
                    b2.Get678(bbw2);
                    bool scc = true;
                    scc = Avv1.AssertEqual(
                              Avv2, verbose, str + ".m_Avv", epsAbs, epsRel) &&
                          scc;
                    scc =
                        Avba1.AssertEqual(
                            Avba2, verbose, str + ".m_Avba", epsAbs, epsRel) &&
                        scc;
                    scc =
                        Avbw1.AssertEqual(
                            Avbw2, verbose, str + ".m_Avbw", epsAbs, epsRel) &&
                        scc;
                    scc = Ababa1.AssertEqual(Ababa2,
                              verbose,
                              str + ".m_Ababa",
                              epsAbs,
                              epsRel) &&
                          scc;
                    scc = Ababw1.AssertEqual(Ababw2,
                              verbose,
                              str + ".m_Ababw",
                              epsAbs,
                              epsRel) &&
                          scc;
                    scc = Abwbw1.AssertEqual(Abwbw2,
                              verbose,
                              str + ".m_Abwbw",
                              epsAbs,
                              epsRel) &&
                          scc;
                    scc = bv1.AssertEqual(
                              bv1, verbose, str + ".bv", epsAbs, epsRel) &&
                          scc;
                    scc = bba1.AssertEqual(
                              bba1, verbose, str + ".bba", epsAbs, epsRel) &&
                          scc;
                    scc = bbw1.AssertEqual(
                              bbw1, verbose, str + ".bbw", epsAbs, epsRel) &&
                          scc;
                    if (scc)
                    {
                        return true;
        ...
        public:
            ...
            {
                bool scc = true;
                scc = m_Acm.AssertEqual(
                          A.m_Acm, verbose, str + ".m_Acm", epsAbs, epsRel) &&
                      scc;
                scc = m_Amm.AssertEqual(
                          A.m_Amm, verbose, str + ".m_Amm", epsAbs, epsRel) &&
                      scc;
                return scc;
            }
        ...
        public:
            ...
            public:
                ...
                static inline CC Get(const LA::AlignedMatrix6x6f& A)
                {
                    return CC(A);
                }
                ...
                inline bool AssertEqual(const CC& A, const int verbose = 1,
                    ...
                    const float epsRel = 0.0f) const
                {
                    LA::AlignedMatrix3x3f App1, Apr1, Arp1, Arr1, App2, Apr2,
                        Arp2, Arr2;
                    ...
                    scc = Apr1.AssertEqual(
                              Apr2, verbose, str + ".m_Apr", epsAbs, epsRel) &&
                          scc;
                    scc = Arp1.AssertEqual(
                              Arp2, verbose, str + ".m_Arp", epsAbs, epsRel) &&
                          scc;
                    scc = Arr1.AssertEqual(
                              Arr2, verbose, str + ".m_Arr", epsAbs, epsRel) &&
                          scc;
                ...
                inline bool AssertZero(
                    const int verbose = 1, const std::string str = "") const
                {
                    return LA::AlignedMatrix6x6f::AssertZero(
                        verbose, str, -1.0f, -1.0f);
                }
            };
            ...
            public:
                ...
                inline bool AssertEqual(const MC& A, const int verbose = 1,
                    const std::string str = "", const float epsAbs = 0.0f,
                    const float epsRel = 0.0f) const
                {
                    LA::AlignedMatrix3x3f Avp1, Avr1, Abap1, Abar1, Abwp1,
                        Abwr1;
                    LA::AlignedMatrix3x3f Avp2, Avr2, Abap2, Abar2, Abwp2,
                        Abwr2;
                    const LA::AlignedMatrix9x6f &A1 = *this, &A2 = A;
                    A1.GetBlock(0, 0, Avp1);
                    A2.GetBlock(0, 0, Avp2);
                    A1.GetBlock(0, 3, Avr1);
                    A2.GetBlock(0, 3, Avr2);
                    A1.GetBlock(3, 0, Abap1);
                    A2.GetBlock(3, 0, Abap2);
                    A1.GetBlock(3, 3, Abar1);
                    A2.GetBlock(3, 3, Abar2);
                    A1.GetBlock(6, 0, Abwp1);
                    A2.GetBlock(6, 0, Abwp2);
                    A1.GetBlock(6, 3, Abwr1);
                    A2.GetBlock(6, 3, Abwr2);
                    bool scc = true;
                    scc = Avp1.AssertEqual(
                              Avp2, verbose, str + ".m_Avp", epsAbs, epsRel) &&
                          scc;
                    scc =
                        Abap1.AssertEqual(
                            Abap2, verbose, str + ".m_Abap", epsAbs, epsRel) &&
                        scc;
                    scc =
                        Abwp1.AssertEqual(
                            Abwp2, verbose, str + ".m_Abwp", epsAbs, epsRel) &&
                        scc;
                    scc = Avr1.AssertEqual(
                              Avr2, verbose, str + ".m_Avr", epsAbs, epsRel) &&
                          scc;
                    scc =
                        Abar1.AssertEqual(
                            Abar2, verbose, str + ".m_Abar", epsAbs, epsRel) &&
                        scc;
                    scc =
                        Abwr1.AssertEqual(
                            Abwr2, verbose, str + ".m_Abwr", epsAbs, epsRel) &&
                        scc;
                    if (scc)
                    {
                        return true;
            ...
            public:
                ...
                inline bool AssertEqual(const MM& A, const int verbose = 1,
                    ...
                    const float epsRel = 0.0f) const
                {
                    LA::AlignedMatrix3x3f Avv1, Avba1, Avbw1, Abav1, Ababa1,
                        Ababw1, Abwv1, Abwba1, Abwbw1;
                    LA::AlignedMatrix3x3f Avv2, Avba2, Avbw2, Abav2, Ababa2,
                        Ababw2, Abwv2, Abwba2, Abwbw2;
                    const LA::AlignedMatrix9x9f &A1 = *this, A2 = A;
                    A1.GetBlock(0, 0, Avv1);
                    A2.GetBlock(0, 0, Avv2);
                    A1.GetBlock(0, 3, Avba1);
                    A2.GetBlock(0, 3, Avba2);
                    A1.GetBlock(0, 6, Avbw1);
                    A2.GetBlock(0, 6, Avbw2);
                    A1.GetBlock(3, 0, Abav1);
                    A2.GetBlock(3, 0, Abav2);
                    A1.GetBlock(3, 3, Ababa1);
                    A2.GetBlock(3, 3, Ababa2);
                    A1.GetBlock(3, 6, Ababw1);
                    A2.GetBlock(3, 6, Ababw2);
                    A1.GetBlock(6, 0, Abwv1);
                    A2.GetBlock(6, 0, Abwv2);
                    A1.GetBlock(6, 3, Abwba1);
                    A2.GetBlock(6, 3, Abwba2);
                    A1.GetBlock(6, 6, Abwbw1);
                    A2.GetBlock(6, 6, Abwbw2);
                    bool scc = true;
                    scc = Avv1.AssertEqual(
                              Avv2, verbose, str + ".m_Avv", epsAbs, epsRel) &&
                          scc;
                    ...
                    scc =
                        Abav1.AssertEqual(
                            Abav2, verbose, str + ".m_Abav", epsAbs, epsRel) &&
                        scc;
                    scc = Ababa1.AssertEqual(Ababa2,
                              verbose,
                              str + ".m_Ababa",
                    ...
                    scc =
                        Abwv1.AssertEqual(
                            Abwv2, verbose, str + ".m_Abwv", epsAbs, epsRel) &&
                        scc;
                    scc = Abwba1.AssertEqual(Abwba2,
                              verbose,
                              str + ".m_Abwba",
                              epsAbs,
                              epsRel) &&
        ...
        public:
            ...
            {
                bool scc = true;
                scc = m_Acc.AssertEqual(
                          A.m_Acc, verbose, str + ".m_Acc", epsAbs, epsRel) &&
                      scc;
                scc = m_Acm.AssertEqual(
                          A.m_Acm, verbose, str + ".m_Acm", epsAbs, epsRel) &&
                      scc;
                scc = m_Amc.AssertEqual(
                          A.m_Amc, verbose, str + ".m_Amc", epsAbs, epsRel) &&
                      scc;
                scc = m_Amm.AssertEqual(
                          A.m_Amm, verbose, str + ".m_Amm", epsAbs, epsRel) &&
                      scc;
            ...
            static inline void AmB(
                const Binary& A, const Binary& B, Binary& AmB)
            {
                CC::AmB(A.m_Acc, B.m_Acc, AmB.m_Acc);
                CM::AmB(A.m_Acm, B.m_Acm, AmB.m_Acm);
    ...
    public:
        ...
        {
        public:
            inline void Set(const Factor::Unitary::CC& A,
                const float* aMax = NULL, const float* eps = NULL)
            {
        ...
        {
        public:
            inline void Set(const LA::AlignedMatrix9x9f& A,
                const float* aMax = NULL, const float* eps = NULL)
            {
        ...
        public:
            ...
            inline void Set(const Factor::Unitary::CC& A,
                const float aMax = 0.0f, const float epsI = 0.0f,
                const float* epsLDL = NULL)
            {
            ...
            template <typename TYPE>
            inline void Apply(const LA::AlignedVector3f& xp,
                const LA::AlignedVector3f& xr, TYPE* Mx) const
            {
        ...
        public:
            ...
            template <typename TYPE>
            inline void Apply(const LA::AlignedVector3f& xv,
    ...
    public:
        ...
        public:
            ...
            inline bool AssertEqual(const Factor::Unitary& A,
                const int verobse = 1, const std::string str = "") const
            {
        ...
        public:
            ...
            inline void AssertEqual(const Factor::Binary& A,
                const int verbose = 1, const std::string str = "") const
            {
...
#else
                m_Acm.AssertEqual(
                    A.m_Acm.GetAlignedMatrix6x9f(), verbose, str + ".m_Acm");
                m_Amm.AssertEqual(
                    A.m_Amm.GetMatrix9x9f(), verbose, str + ".m_Amm");
#endif
            }
    ...
    public:
        ...
        public:
            ...
            public:
                ...
                inline void Print(
                    const std::string str = "", const bool l = true) const
                {
                    if (!Valid())
                    {
                        return;
            ...
            inline void Set(const float w, const LA::Vector3f& s2r,
                const float s2p, const Rotation3D& R)
            {
            ...
            inline void GetError(
                const Rigid3D& T, Error& e, const float eps) const
            {
                Rotation3D eR;
                // Rotation3D RT;
            ...
            inline void GetError(const ErrorJacobian& Je,
                const LA::AlignedVector3f& xp, const LA::AlignedVector3f& xr,
                Error& e) const
            {
                e = Je.m_e;
                e.m_ep += xp;
            ...
            inline void GetErrorJacobian(
                const Rigid3D& T, ErrorJacobian& Je, const float eps) const
            {
                Rotation3D eR;
                // Rotation3D RT;
                // LA::AlignedVector3f g;
                ...
                Rotation3D::GetRodriguesJacobianInverse(
                    Je.m_e.m_er, Je.m_Jr, eps);
                Je.m_Jr = Je.m_Jr * eR;
            }
            inline void GetFactor(
                const Rigid3D& T, Factor& A, const float eps) const
            {
            ...
            inline void GetReduction(const Factor& A, const Rigid3D& T,
                const LA::AlignedVector3f& xp, const LA::AlignedVector3f& xr,
        ...
        public:
            ...
            float EigenGetCost(const Rigid3D& T, const EigenVector6f& e_x,
        ...
        public:
            ...
            inline void GetReduction(const Factor& A,
                const LA::AlignedVector3f& v1, const LA::AlignedVector3f& v2,
                const float* x, Reduction& Ra, Reduction& Rp) const
            {
                Ra.m_e = v2;
                Rp.m_e.Set(x);
                Rp.m_e += v1;
        ...
        public:
            ...
            inline float GetCost(const float e) const { return m_w * e * e; }
            inline float GetCost(const float pz, const float xpz) const
            {
                return GetCost(pz + xpz);
            }
            inline void GetReduction(const Factor& A, const float pz1,
                const float pz2, const float xpz, Reduction& Ra,
                Reduction& Rp) const
            {
        ...
        public:
            ...
            public:
                ...
                inline void AccumulateVelocity(const LA::AlignedVector3f& e,
                    const float F, const int iFrm = -1)
                {
                    m_ESv.Accumulate(ESError(e), F, iFrm);
                }
                inline void AccumulateBiasAcceleration(
                    const LA::AlignedVector3f& e, const float F,
                    const int iFrm = -1)
                {
                    m_ESba.Accumulate(ESError(e), F, iFrm);
                }
                inline void AccumulateBiasGyroscope(
                    const LA::AlignedVector3f& e, const float F,
                    const int iFrm = -1)
                {
                    m_ESbw.Accumulate(
                        ESError(e, UT_FACTOR_RAD_TO_DEG), F, iFrm);
                }
                inline float Total() const
                {
                    return m_ESv.m_SF + m_ESba.m_SF + m_ESbw.m_SF;
                }
...
public:
    inline Camera() {}
    inline Camera(const Camera& C) { memcpy(this, &C, sizeof(Camera)); }
    inline Camera(const Camera& C, const LA::AlignedVector3f* dp,
        const LA::AlignedVector3f* dr, const LA::AlignedVector3f* dv,
        const LA::AlignedVector3f* dba, const LA::AlignedVector3f* dbw,
        const float eps)
        : m_T(C.m_T, dp, dr, eps)
    {
        m_T.GetPosition(m_p);
    ...
    inline bool AssertEqual(const Camera& C, const int verbose = 1,
        const std::string str = "", const float rEps = 0.001745329252f,
        const float pEps = 0.0f, const float vEps = 0.0f) const
    {
