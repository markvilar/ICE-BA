...
public:
    ...
    static inline void Interpolate(const Measurement& u1, const Measurement& u2,
        const float t, LA::AlignedVector3f& a, LA::AlignedVector3f& w)
    {
...
public:
    ...
    public:
        ...
        public:
            ...
            inline void IncreaseDiagonal(
                const float s2r, const float s2v, const float s2p)
            {
    ...
    public:
        ...
        inline void IncreaseDiagonal(const float s2r, const float s2v,
            const float s2p, const float s2ba, const float s2bw)
        {
    ...
    public:
        ...
        static inline void AddABTTo(
            const Transition::DB& A, const DB& B, DD* ABT)
        {
        ...
        static inline void AddABTTo(
            const Transition::DB& A, const BB& B, DB* ABT)
        {
        ...
        static inline void ABT(
            const Transition& A, const Covariance& B, DD* ABTdd, DB* ABTdb)
        {
        ...
        static inline void ABTToUpper(
            const DD& A, const Transition::DD& B, DD* ABT)
        {
            ABT->m_Prr = A.m_Prr;
            ...
            ABT->m_Prp += A.m_Prp;
            ABT->m_Pvv = A.m_Pvv;
            // LA::AlignedMatrix3x3f::AddABTToUpper(A.m_Pvr, B.m_Fvr,
            // ABT->m_Pvv);
            ...
            ABT->m_Pvp += A.m_Pvp;
            ABT->m_Ppp = A.m_Ppp;
            // LA::AlignedMatrix3x3f::AddABTToUpper(A.m_Ppr, B.m_Fpr,
            // ABT->m_Ppp);
            SkewSymmetricMatrix::AddABTToUpper(A.m_Ppr, B.m_Fpr, ABT->m_Ppp);
            // LA::AlignedMatrix3x3f::AddABTToUpper(A.m_Ppv, B.m_Fpv,
            // ABT->m_Ppp);
            LA::AlignedMatrix3x3f::AddsAToUpper(B.m_Fpv, A.m_Ppv, ABT->m_Ppp);
        }
        static inline void AddABTToUpper(
            const DB& A, const Transition::DB& B, DD* ABT)
        {
            LA::AlignedMatrix3x3f::AddABTToUpper(
                A.m_Prbw, B.m_Frbw, ABT->m_Prr);
            LA::AlignedMatrix3x3f::AddABTTo(A.m_Prbw, B.m_Fvbw, ABT->m_Prv);
            LA::AlignedMatrix3x3f::AddABTTo(A.m_Prbw, B.m_Fpbw, ABT->m_Prp);
            LA::AlignedMatrix3x3f::AddABTToUpper(
                A.m_Pvba, B.m_Fvba, ABT->m_Pvv);
            LA::AlignedMatrix3x3f::AddABTToUpper(
                A.m_Pvbw, B.m_Fvbw, ABT->m_Pvv);
            LA::AlignedMatrix3x3f::AddABTTo(A.m_Pvba, B.m_Fpba, ABT->m_Pvp);
            LA::AlignedMatrix3x3f::AddABTTo(A.m_Pvbw, B.m_Fpbw, ABT->m_Pvp);
            LA::AlignedMatrix3x3f::AddABTToUpper(
                A.m_Ppba, B.m_Fpba, ABT->m_Ppp);
            LA::AlignedMatrix3x3f::AddABTToUpper(
                A.m_Ppbw, B.m_Fpbw, ABT->m_Ppp);
        }
        static inline void ABTToUpper(
            const DD& Add, const DB& Adb, const Transition& B, DD* ABT)
        {
            ABTToUpper(Add, B.m_Fdd, ABT);
            AddABTToUpper(Adb, B.m_Fdb, ABT);
        }
        static inline void FPFT(
            const Transition& F, const Covariance& P, DD* U, Covariance* FPFT)
        {
    ...
    public:
        ...
        static inline bool AssertEqual(const LA::AlignedMatrix3x3f& W1,
            const LA::AlignedMatrix3x3f& W2, const int verbose = 1,
            const std::string str = "", const bool norm = true)
        {
            if (norm)
            {
                const float n1 = sqrt(W1.SquaredFrobeniusNorm());
    ...
    public:
        ...
        inline void Print(
            const std::string str, const bool e, const bool l) const
        {
            UT::PrintSeparator();
    ...
    public:
        ...
        public:
            ...
            static inline void AmB(
                const Unitary& A, const Unitary& B, Unitary& AmB)
            {
        ...
        public:
            ...
            public:
                    ...
                    Camera::Factor::Binary* A12) const
                {
                    ...
                    A11->m_Amm.m_A.Set(m_Av1v1,
                        m_Av1ba1,
                        m_Av1bw1,
                        m_Aba1ba1,
                        m_Aba1bw1,
                        m_Abw1bw1);
                    A12->m_Amc.Set(m_Av1p2,
                        m_Av1r2,
                        m_Aba1p2,
                        m_Aba1r2,
                        m_Abw1p2,
            ...
            public:
                ...
                LA::AlignedMatrix3x3f m_JTWp1p, m_JTWr1p, m_JTWv1p, m_JTWba1p,
                    m_JTWbw1p, m_JTWr2p;
                LA::SymmetricMatrix3x3f m_Ap1p1, m_Ar1r1, m_Av1v1, m_Aba1ba1,
                    m_Abw1bw1;
                LA::SymmetricMatrix3x3f m_Ap2p2, m_Ar2r2, m_Av2v2;
                LA::AlignedVector3f m_bp1, m_br1, m_bv1, m_bba1, m_bbw1, m_bp2,
                    m_br2, m_bv2, m_bba2, m_bbw2;
                LA::AlignedMatrix3x3f m_Ap1r1, m_Ap1v1, m_Ap1ba1, m_Ap1bw1,
                    m_Ap1p2, m_Ap1r2;
                LA::AlignedMatrix3x3f m_Ar1v1, m_Ar1ba1, m_Ar1bw1, m_Ar1p2,
                    m_Ar1r2, m_Ar1v2;
                LA::AlignedMatrix3x3f m_Av1ba1, m_Av1bw1, m_Av1p2, m_Av1r2,
                    m_Av1v2;
            ...
            {
            public:
                void Set(const Jacobian::RelativeLF& J, const Error& e,
                    const float w, const Weight& W, const float Tpv);
            ...
            {
            public:
                void Set(const Jacobian::RelativeKF& J, const Error& e,
                    const float w, const Weight& W, const float Tpv);
#ifdef CFG_IMU_FULL_COVARIANCE
                inline void Get(Unitary* A11, Unitary* A22,
                    Camera::Factor::Binary* A12) const
            ...
            public:
                ...
                LA::AlignedMatrix3x3f m_JTWv1p, m_JTWba1p, m_JTWbw1p, m_JTWp2p,
                    m_JTWr2p;
                LA::AlignedMatrix2x3f m_JTWgv, m_JTWgp;
                LA::SymmetricMatrix3x3f m_Av1v1, m_Aba1ba1, m_Abw1bw1, m_Ap2p2,
                    m_Ar2r2, m_Av2v2;
                LA::AlignedVector3f m_bv1, m_bba1, m_bbw1, m_bp2, m_br2, m_bv2,
                    m_bba2, m_bbw2;
                LA::AlignedMatrix3x3f m_Av1ba1, m_Av1bw1, m_Av1p2, m_Av1r2,
                    m_Av1v2;
                LA::AlignedMatrix3x3f m_Aba1bw1, m_Aba1p2, m_Aba1r2, m_Aba1v2;
                ...
                float m_Aba1ba2, m_Abw1bw2, m_Aba2ba2, m_Abw2bw2;
                LA::SymmetricMatrix2x2f m_Agg;
                LA::AlignedMatrix2x3f m_Agv1, m_Agba1, m_Agbw1, m_Agp2, m_Agr2,
                    m_Agv2;
                LA::Vector2f m_bg;
#endif
            };
    ...
    public:
            ...
            const Error& e, const float F, const int iFrm = -1)
        {
            ...
            m_ESr.Accumulate(
                ESError(e.m_er, UT_FACTOR_RAD_TO_DEG), -1.0f, iFrm);
...
public:
    ...
    inline Rotation3D GetRotationMeasurement(
        const Camera& C1, const float eps) const
    {
        return m_RT / Rotation3D(m_Jrbw * (C1.m_bw - m_bw), eps);
    }
    inline Rotation3D GetRotationMeasurement(
        const LA::AlignedVector3f& dbw, const float eps) const
    {
        return m_RT / Rotation3D(m_Jrbw * dbw, eps);
    }
    inline LA::AlignedVector3f GetRotationError(
        const Camera& C1, const Camera& C2, const float eps) const
    {
        const Rotation3D eR =
    ...
    inline LA::AlignedVector3f GetVelocityState(
        const Camera& C1, const Camera& C2) const
    {
    ...
    inline LA::AlignedVector3f GetPositionState(
        const Camera& C1, const Camera& C2, const Point3D& pu) const
    {
    ...
    inline LA::AlignedVector3f GetPositionError(
        const Camera& C1, const Camera& C2, const Point3D& pu) const
    {
    ...
    inline void DebugSetMeasurement(
        const Camera& C1, const Camera& C2, const Point3D& pu, const float eps)
    {
    ...
    static inline void GetError(const ErrorJacobian& Je,
    ...
    {
#ifdef CFG_DEBUG
        UT_ASSERT(xp1 || xr1 || xv1 || xba1 || xbw1 || xp2 || xr2 || xv2 ||
                  xba2 || xbw2);
#endif
        e = Je.m_e;
        if (xp1)
        {
            if (xp2)
            {
                ...
                LA::AlignedMatrix3x3f::AddAbTo(
                    Je.m_J.m_Jpp1, dxp, (float*)&e.m_ep);
            }
            else
            {
                LA::AlignedMatrix3x3f::AddAbTo(
                    Je.m_J.m_Jpp1, *xp1, (float*)&e.m_ep);
            }
        }
        else if (xp2)
        {
            LA::AlignedMatrix3x3f::SubtractAbFrom(
                Je.m_J.m_Jpp1, *xp2, (float*)&e.m_ep);
        }
        if (xr1)
        {
            if (xr2)
            {
                ...
                LA::AlignedMatrix3x3f::AddAbTo(
                    Je.m_J.m_Jrr1, dxr, (float*)&e.m_er);
                LA::AlignedMatrix3x3f::AddAbTo(
                    Je.m_J.m_Jpr2, *xr2, (float*)&e.m_ep);
            }
            else
            {
                LA::AlignedMatrix3x3f::AddAbTo(
                    Je.m_J.m_Jrr1, *xr1, (float*)&e.m_er);
            }
            LA::AlignedMatrix3x3f::AddAbTo(
                Je.m_J.m_Jvr1, *xr1, (float*)&e.m_ev);
            LA::AlignedMatrix3x3f::AddAbTo(
                Je.m_J.m_Jpr1, *xr1, (float*)&e.m_ep);
        }
        else if (xr2)
        {
            LA::AlignedMatrix3x3f::SubtractAbFrom(
                Je.m_J.m_Jrr1, *xr2, (float*)&e.m_er);
            LA::AlignedMatrix3x3f::AddAbTo(
                Je.m_J.m_Jpr2, *xr2, (float*)&e.m_ep);
        }
        if (xv1)
        {
            if (xv2)
            {
                ...
                LA::AlignedMatrix3x3f::AddAbTo(
                    Je.m_J.m_Jvv1, dxv, (float*)&e.m_ev);
            }
            else
            {
                LA::AlignedMatrix3x3f::AddAbTo(
                    Je.m_J.m_Jvv1, *xv1, (float*)&e.m_ev);
            }
            LA::AlignedMatrix3x3f::AddAbTo(
                Je.m_J.m_Jpv1, *xv1, (float*)&e.m_ep);
        }
        else if (xv2)
        {
            LA::AlignedMatrix3x3f::SubtractAbFrom(
                Je.m_J.m_Jvv1, *xv2, (float*)&e.m_ev);
        }
        if (xba1)
        {
            LA::AlignedMatrix3x3f::AddAbTo(
                Je.m_J.m_Jvba1, *xba1, (float*)&e.m_ev);
            LA::AlignedMatrix3x3f::AddAbTo(
                Je.m_J.m_Jpba1, *xba1, (float*)&e.m_ep);
            e.m_eba += *xba1;
        }
        if (xbw1)
        {
            LA::AlignedMatrix3x3f::AddAbTo(
                Je.m_J.m_Jrbw1, *xbw1, (float*)&e.m_er);
            LA::AlignedMatrix3x3f::AddAbTo(
                Je.m_J.m_Jvbw1, *xbw1, (float*)&e.m_ev);
            LA::AlignedMatrix3x3f::AddAbTo(
                Je.m_J.m_Jpbw1, *xbw1, (float*)&e.m_ep);
            e.m_ebw += *xbw1;
        }
        if (xba2)
        {
    ...
    static inline void GetError(const Jacobian::RelativeLF& J,
        const LA::Vector2f& xg, const LA::AlignedVector3f& xp1,
        ...
        const LA::AlignedVector3f& xbw2, const float Tpv, Error& e)
    {
        const LA::AlignedVector3f dxr = xr1 - xr2;
    ...
    static inline void GetError(const Jacobian::RelativeKF& J,
        const LA::Vector2f& xg, const LA::AlignedVector3f& xv1,
        const LA::AlignedVector3f& xba1, const LA::AlignedVector3f& xbw1,
        const LA::AlignedVector3f& xp2, const LA::AlignedVector3f& xr2,
        const LA::AlignedVector3f& xv2, const LA::AlignedVector3f& xba2,
        const LA::AlignedVector3f& xbw2, const float Tpv, Error& e)
    ...
    inline void GetErrorJacobian(const Camera& C1, const Camera& C2,
        const Point3D& pu, Error* e, Jacobian::Global* J, const float eps) const
    {
#ifdef CFG_IMU_FULL_COVARIANCE
    ...
    inline void GetErrorJacobian(const Camera& C1, const Camera& C2,
        ...
        Jacobian::RelativeLF* J, const float eps) const
    {
#ifdef CFG_IMU_FULL_COVARIANCE
        const Rotation3D dR = GetRotationState(C1, C2);
        const LA::AlignedVector3f drbw = m_Jrbw * (C1.m_bw - m_bw);
    ...
    inline void GetFactor(const float w, const Camera& C1, const Camera& C2,
        const Point3D& pu, Factor* A, Camera::Factor::Binary* A12,
    ...
    inline void GetFactor(const float w, const Camera& C1, const Camera& C2,
        const Point3D& pu, const Rotation3D& Rg, Error* e,
        Jacobian::RelativeLF* J, Factor::Auxiliary::RelativeLF* U,
        const float eps) const
    {
    ...
    inline void GetFactor(const float w, const Camera& C1, const Camera& C2,
        const Point3D& pu, Error* e, Jacobian::RelativeKF* J,
        Factor::Auxiliary::RelativeKF* U, const float eps) const
    {
...
#else
        return w *
               (LA::SymmetricMatrix3x3f::MahalanobisDistance(W.m_Wr, e.m_er) +
                   LA::SymmetricMatrix3x3f::MahalanobisDistance(
                       W.m_Wv, e.m_ev) +
                   LA::SymmetricMatrix3x3f::MahalanobisDistance(
                       W.m_Wp, e.m_ep) +
    ...
    inline void GetReduction(const float w, const Factor& A, const Camera& C1,
        const Camera& C2, const Point3D& pu, const LA::AlignedVector3f* xp1,
        const LA::AlignedVector3f* xr1, const LA::AlignedVector3f* xv1,
        const LA::AlignedVector3f* xba1, const LA::AlignedVector3f* xbw1,
        const LA::AlignedVector3f* xp2, const LA::AlignedVector3f* xr2,
        const LA::AlignedVector3f* xv2, const LA::AlignedVector3f* xba2,
    ...
    inline bool AssertEqual(const Delta& D, const int verbose = 1,
        const std::string str = "", const bool normWeight = true) const
    {
        bool scc = true;
...
public:
    ...
    public:
        ...
        public:
            ...
            inline void Set(const Transition::DD& F)
            {
                ...
                block<3, 3>(3, 0) =
                    EigenMatrix3x3f(F.m_Fvr.GetAlignedMatrix3x3f());
                block<3, 3>(6, 0) =
                    EigenMatrix3x3f(F.m_Fpr.GetAlignedMatrix3x3f());
                block<3, 3>(6, 3) = EigenMatrix3x3f(F.m_Fpv[0]);
            }
            inline bool AssertEqual(const Transition::DD& F,
                const int verbose = 1, const std::string str = "") const
            {
                ...
                scc = EigenMatrix3x3f(block<3, 3>(3, 0))
                          .AssertEqual(F.m_Fvr.GetAlignedMatrix3x3f(),
                              verbose,
                              str + ".Fvr") &&
                      scc;
                ...
                scc = EigenMatrix3x3f(block<3, 3>(6, 0))
                          .AssertEqual(F.m_Fpr.GetAlignedMatrix3x3f(),
                              verbose,
                              str + ".Fpr") &&
                      scc;
                ...
                scc = EigenMatrix3x3f(block<3, 3>(6, 3))
                          .AssertEqual(EigenMatrix3x3f(F.m_Fpv[0]),
                              verbose,
                              str + ".Fpv") &&
                      scc;
        ...
        public:
            ...
            inline bool AssertEqual(const Transition::DB& F,
                const int verbose = 1, const std::string str = "") const
            {
                bool scc = true;
                scc = EigenMatrix3x3f(block<3, 3>(0, 0))
    ...
    public:
            ...
            const std::string str = "") const
        {
            bool scc = true;
            scc =
                DD(block<9, 9>(0, 0)).AssertEqual(F.m_Fdd, verbose, str) && scc;
            scc =
                DB(block<9, 6>(0, 9)).AssertEqual(F.m_Fdb, verbose, str) && scc;
            scc = EigenMatrix6x9f(block<6, 9>(9, 0)).AssertZero(verbose, str) &&
                  scc;
    ...
    public:
        ...
        public:
            ...
            {
                P->m_Prr =
                    EigenMatrix3x3f(block<3, 3>(0, 0)).GetAlignedMatrix3x3f();
                P->m_Prv =
                    EigenMatrix3x3f(block<3, 3>(0, 3)).GetAlignedMatrix3x3f();
                P->m_Prp =
                    EigenMatrix3x3f(block<3, 3>(0, 6)).GetAlignedMatrix3x3f();
                P->m_Pvr =
                    EigenMatrix3x3f(block<3, 3>(3, 0)).GetAlignedMatrix3x3f();
                P->m_Pvv =
                    EigenMatrix3x3f(block<3, 3>(3, 3)).GetAlignedMatrix3x3f();
                P->m_Pvp =
                    EigenMatrix3x3f(block<3, 3>(3, 6)).GetAlignedMatrix3x3f();
                P->m_Ppr =
                    EigenMatrix3x3f(block<3, 3>(6, 0)).GetAlignedMatrix3x3f();
                P->m_Ppv =
                    EigenMatrix3x3f(block<3, 3>(6, 3)).GetAlignedMatrix3x3f();
                P->m_Ppp =
                    EigenMatrix3x3f(block<3, 3>(6, 6)).GetAlignedMatrix3x3f();
            }
            inline bool AssertEqual(const Covariance::DD& P,
                const int verbose = 1, const std::string str = "") const
            {
                bool scc = true;
                scc = EigenMatrix3x3f(block<3, 3>(0, 0))
        ...
        public:
            ...
            inline bool AssertEqual(const Covariance::DB& P,
                const int verbose = 1, const std::string str = "") const
            {
                bool scc = true;
                scc = EigenMatrix3x3f(block<3, 3>(0, 0))
        ...
        public:
            ...
            inline bool AssertEqual(const Covariance::BD& P,
                const int verbose = 1, const std::string str = "") const
            {
                bool scc = true;
                scc = EigenMatrix3x3f(block<3, 3>(0, 0))
        ...
        public:
            ...
            inline bool AssertEqual(const Covariance::BB& P,
                const int verbose = 1, const std::string str = "") const
            {
                bool scc = true;
                scc = EigenMatrix3x3f(block<3, 3>(0, 0))
                          .AssertEqual(EigenMatrix3x3f(P.m_Pbaba),
                              verbose,
                              str + ".Pbaba") &&
                      scc;
                scc = EigenMatrix3x3f(block<3, 3>(0, 3))
                ...
                scc = EigenMatrix3x3f(block<3, 3>(3, 0))
                      ...
                      scc;
                scc = EigenMatrix3x3f(block<3, 3>(3, 3))
                          .AssertEqual(EigenMatrix3x3f(P.m_Pbwbw),
                              verbose,
                              str + ".Pbwbw") &&
                      scc;
                return scc;
    ...
    public:
            ...
            const std::string str = "") const
        {
            bool scc = true;
            scc =
                DD(block<9, 9>(0, 0)).AssertEqual(P.m_Pdd, verbose, str) && scc;
            scc =
                DB(block<9, 6>(0, 9)).AssertEqual(P.m_Pdb, verbose, str) && scc;
            // scc = BD(block<6, 9>(9, 0)).AssertEqual(P.m_Pbd, verbose, str) &&
            // scc;
            scc =
                BB(block<6, 6>(9, 9)).AssertEqual(P.m_Pbb, verbose, str) && scc;
            return scc;
        }
    };
    ...
    public:
        ...
        {
            bool scc = true;
            scc = m_er.AssertEqual(
                      e_e.m_er, verbose, str + ".m_er", epsAbs, epsRel) &&
                  scc;
            scc = m_ev.AssertEqual(
                      e_e.m_ev, verbose, str + ".m_ev", epsAbs, epsRel) &&
                  scc;
            scc = m_ep.AssertEqual(
                      e_e.m_ep, verbose, str + ".m_ep", epsAbs, epsRel) &&
                  scc;
            scc = m_eba.AssertEqual(
                      e_e.m_eba, verbose, str + ".m_eba", epsAbs, epsRel) &&
                  scc;
            scc = m_ebw.AssertEqual(
                      e_e.m_ebw, verbose, str + ".m_ebw", epsAbs, epsRel) &&
                  scc;
            return scc;
        }
    ...
    public:
        ...
        public:
            ...
            inline bool AssertEqual(const Jacobian::Gravity& J,
                const int verbose = 1, const std::string str = "") const
            {
                ...
                const int verbose = 1, const std::string str = "") const
            {
                bool scc = true;
                scc =
                    m_JvgT.AssertEqual(e_J.m_JvgT, verbose, str + ".m_JvgT") &&
                    scc;
                scc =
                    m_JpgT.AssertEqual(e_J.m_JpgT, verbose, str + ".m_JpgT") &&
                    scc;
                return scc;
            }
        ...
        public:
            ...
            inline bool AssertEqual(const Jacobian::Global& J,
                const int verbose = 1, const std::string str = "") const
            {
                ...
                const int verbose = 1, const std::string str = "") const
            {
                ...
                scc = m_Jba.AssertEqual(e_J.m_Jba, verbose, str + ".m_Jba") &&
                      scc;
                scc = m_Jbw.AssertEqual(e_J.m_Jbw, verbose, str + ".m_Jbw") &&
                      scc;
                return scc;
            }
        ...
        public:
            ...
            inline void Set(const Jacobian::RelativeLF& J, const float Tpv)
            {
                ...
                m_Jv.block<3, 3>(0, 6) =
                    EigenMatrix3x3f(-EigenMatrix3x3f::Identity());
            ...
            inline void Get(
                EigenMatrix15x2f* e_Jg, EigenMatrix15x30f* e_Jc) const
            {
                Gravity::Get(e_Jg);
                Global::Get(e_Jc);
            }
            inline bool AssertEqual(const Jacobian::RelativeLF& J,
                const float Tpv, const int verbose = 1,
                const std::string str = "") const
            {
        ...
        public:
            ...
            inline bool AssertEqual(const Jacobian::RelativeKF& J,
                const float Tpv, const int verbose = 1,
                const std::string str = "") const
            {
    ...
    public:
        ...
        public:
            ...
            inline void Set(const EigenMatrix30x31f& A, const float F)
            {
                Set(EigenMatrix30x30f(A.block<30, 30>(0, 0)),
                    EigenVector30f(A.block<30, 1>(0, 30)),
                    F);
            }
            ...
            inline void Set(const Factor::Unitary& A11,
                const Factor::Unitary& A22, const Camera::Factor::Binary& A12,
                const float F)
            {
            ...
            inline bool AssertEqual(const Factor& A,
                const Camera::Factor::Binary& A12, const int verbose = 1,
                const std::string str = "") const
            {
                Global e_A;
                e_A.Set(A, A12);
            ...
            inline bool AssertEqual(const Factor::Unitary& A11,
                const Factor::Unitary& A22, const Camera::Factor::Binary& A12,
                const float F, const int verbose = 1,
                const std::string str = "") const
            {
                Global e_A;
                ...
                const std::string str = "") const
            {
                bool scc = true;
                scc =
                    m_Ac1c1.AssertEqual(A.m_Ac1c1, verbose, str + ".m_Ac1c1") &&
                    scc;
                scc =
                    m_Ac1m1.AssertEqual(A.m_Ac1m1, verbose, str + ".m_Ac1m1") &&
                    scc;
                scc =
                    m_Ac1c2.AssertEqual(A.m_Ac1c2, verbose, str + ".m_Ac1c2") &&
                    scc;
                scc =
                    m_Ac1m2.AssertEqual(A.m_Ac1m2, verbose, str + ".m_Ac1m2") &&
                    scc;
                scc =
                    m_bc1.AssertEqual(A.m_bc1, verbose, str + ".m_bc1") && scc;

                scc =
                    m_Am1m1.AssertEqual(A.m_Am1m1, verbose, str + ".m_Am1m1") &&
                    scc;
                scc =
                    m_Am1c2.AssertEqual(A.m_Am1c2, verbose, str + ".m_Am1c2") &&
                    scc;
                scc =
                    m_Am1m2.AssertEqual(A.m_Am1m2, verbose, str + ".m_Am1m2") &&
                    scc;
                scc =
                    m_bm1.AssertEqual(A.m_bm1, verbose, str + ".m_bm1") && scc;

                scc =
                    m_Ac2c2.AssertEqual(A.m_Ac2c2, verbose, str + ".m_Ac2c2") &&
                    scc;
                scc =
                    m_Ac2m2.AssertEqual(A.m_Ac2m2, verbose, str + ".m_Ac2m2") &&
                    scc;
                scc =
                    m_bc2.AssertEqual(A.m_bc2, verbose, str + ".m_bc2") && scc;

                scc =
                    m_Am2m2.AssertEqual(A.m_Am2m2, verbose, str + ".m_Am2m2") &&
                    scc;
                scc =
                    m_bm2.AssertEqual(A.m_bm2, verbose, str + ".m_bm2") && scc;
        ...
        public:
            inline void Set(
                const Factor::Auxiliary::RelativeLF& A, const float F)
            {
#ifdef CFG_IMU_FULL_COVARIANCE
                ...
                m_Ac1m1 = EigenMatrix6x9f(A.m_Ap1v1,
                    A.m_Ap1ba1,
                    A.m_Ap1bw1,
                    A.m_Ar1v1,
                    A.m_Ar1ba1,
                    A.m_Ar1bw1);
                m_Ac1c2 =
                    EigenMatrix6x6f(A.m_Ap1p2, A.m_Ap1r2, A.m_Ar1p2, A.m_Ar1r2);
                m_Ac1m2.setZero();
                m_Ac1m2.block<3, 3>(3, 0) = EigenMatrix3x3f(A.m_Ar1v2);
                m_bc1 = EigenVector6f(A.m_bp1, A.m_br1);
                m_Am1m1 = EigenMatrix9x9f(A.m_Av1v1,
                    A.m_Av1ba1,
                    A.m_Av1bw1,
                    A.m_Aba1ba1,
                    A.m_Aba1bw1,
                    A.m_Abw1bw1);
                m_Am1c2 = EigenMatrix9x6f(A.m_Av1p2,
                    A.m_Av1r2,
                    A.m_Aba1p2,
                    A.m_Aba1r2,
                    A.m_Abw1p2,
            ...
            inline bool AssertEqual(const RelativeLF& e_A,
                const int verbose = 1, const std::string str = "") const
            {
                bool scc = true;
                scc = Global::AssertEqual(e_A, verbose, str) && scc;
                scc = m_Agg.AssertEqual(e_A.m_Agg, verbose, str + ".m_Agg") &&
                      scc;
                scc =
                    m_Agc1.AssertEqual(e_A.m_Agc1, verbose, str + ".m_Agc1") &&
                    scc;
                scc =
                    m_Agm1.AssertEqual(e_A.m_Agm1, verbose, str + ".m_Agm1") &&
                    scc;
                scc =
                    m_Agc2.AssertEqual(e_A.m_Agc2, verbose, str + ".m_Agc2") &&
                    scc;
                scc =
                    m_Agm2.AssertEqual(e_A.m_Agm2, verbose, str + ".m_Agm2") &&
                    scc;
        ...
        public:
            inline void Set(
                const Factor::Auxiliary::RelativeKF& A, const float F)
            {
                m_Ac1c1.setZero();
                m_Ac1m1.setZero();
                m_Ac1c2.setZero();
    ...
    void EigenGetErrorJacobian(const Camera& C1, const Camera& C2,
        const Point3D& pu, EigenError* e_e, EigenJacobian::Global* e_J,
        const float eps) const;
    void EigenGetErrorJacobian(const Camera& C1, const Camera& C2,
        const Point3D& pu, const Rotation3D& Rg, EigenError* e_e,
        EigenJacobian::RelativeLF* e_J, const float eps) const;
    void EigenGetErrorJacobian(const Camera& C1, const Camera& C2,
        const Point3D& pu, EigenError* e_e, EigenJacobian::RelativeKF* e_J,
        const float eps) const;
    void EigenGetFactor(const float w, const Camera& C1, const Camera& C2,
        const Point3D& pu, EigenFactor::Global* e_A, const float eps) const;
    void EigenGetFactor(const float w, const Camera& C1, const Camera& C2,
        const Point3D& pu, const Rotation3D& Rg, EigenFactor::RelativeLF* e_A,
        const float eps) const;
    void EigenGetFactor(const float w, const Camera& C1, const Camera& C2,
        const Point3D& pu, EigenFactor::RelativeKF* e_A, const float eps) const;
    static void EigenGetFactor(const float w, const Weight& W,
        const EigenJacobian::Global& e_J, const EigenError& e_e,
        EigenFactor::Global* e_A);
    static void EigenGetFactor(const float w, const Weight& W,
        const EigenJacobian::RelativeLF& e_J, const EigenError& e_e,
        EigenFactor::RelativeLF* e_A);
    static EigenError EigenGetError(
        const EigenErrorJacobian& e_Je, const EigenVector30f e_x);
...
void PreIntegrate(const AlignedVector<Measurement>& us, const float t1,
    const float t2, const Camera& C1, Delta* D, AlignedVector<float>* work,
    const bool jac /* = true*/, const Measurement* u1 /* = NULL*/,
