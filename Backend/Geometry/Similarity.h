...
public:
    ...
    inline const float& sr00() const { return r00(); }
    inline float& sr00() { return r00(); }
    inline const float& sr01() const { return r01(); }
    inline float& sr01() { return r01(); }
    inline const float& sr02() const { return r02(); }
    inline float& sr02() { return r02(); }
    inline const float& tx() const { return r0(); }
    inline float& tx() { return r0(); }
    inline const float& sr10() const { return r10(); }
    inline float& sr10() { return r10(); }
    inline const float& sr11() const { return r11(); }
    inline float& sr11() { return r11(); }
    inline const float& sr12() const { return r12(); }
    inline float& sr12() { return r12(); }
    inline const float& ty() const { return r1(); }
    inline float& ty() { return r1(); }
    inline const float& sr20() const { return r20(); }
    inline float& sr20() { return r20(); }
    inline const float& sr21() const { return r21(); }
    inline float& sr21() { return r21(); }
    inline const float& sr22() const { return r22(); }
    inline float& sr22() { return r22(); }
    ...
    inline void Set(const float s12, const Quaternion& q1, const Quaternion& q2,
    ...
    inline void ApplyRotation(const Point3D& X, LA::AlignedVector3f& RX) const
    {
        m_R.Apply(X, RX);
    }
    inline void ApplyRotationScale(
        const Point3D& X, LA::AlignedVector3f& sRX) const
    {
        Rotation3D::Apply(X, sRX);
    }
    inline LA::AlignedVector3f GetApplied(const Point3D& X) const
    {
        LA::AlignedVector3f SX;
        Apply(X, SX);
        return SX;
    }
...
#ifdef _MSC_VER
    inline EigenSimilarity3D(const Similarity3D& S)
        : m_s(S.m_s[0]), m_R(S.m_R), m_t(S.m_t)
    {
    }
#else
    inline EigenSimilarity3D(const Similarity3D& S)
...
#endif // _MSC_VER
    inline EigenSimilarity3D(
        const float e_s, const EigenRotation3D& e_R, const EigenVector3f& e_t)
        : m_s(e_s), m_R(e_R), m_t(e_t)
    {
    }
