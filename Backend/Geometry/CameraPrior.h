...
public:
    inline C() {}
    inline C(const LA::AlignedVector6f& b)
    {
        *((LA::AlignedVector6f*)this) = b;
    }
...
public:
    inline M() {}
    inline M(const LA::AlignedVector9f& b)
    {
        *((LA::AlignedVector9f*)this) = b;
    }
...
{
public:
    inline void Set(const float* e)
    {
        m_ep.Set(e);
        m_er.Set(e + 3);
    }
    inline void Set(const double* e)
    {
        m_ep.Set(e);
        m_er.Set(e + 3);
    }
    inline void Get(float* e) const
    {
        m_ep.Get(e);
        m_er.Get(e + 3);
    }
    inline void Get(double* e) const
    {
        m_ep.Get(e);
        m_er.Get(e + 3);
    }
...
public:
    inline RR() {}
    inline RR(const LA::SymmetricMatrix2x2f& A)
    {
        *((LA::SymmetricMatrix2x2f*)this) = A;
    }
};
...
public:
    inline RC() {}
    inline RC(const LA::AlignedMatrix2x6f& A)
    {
        *((LA::AlignedMatrix2x6f*)this) = A;
    }
...
public:
    inline RM() {}
    inline RM(const LA::AlignedMatrixMxNf<2, 9>& A)
    {
        *((LA::AlignedMatrixMxNf<2, 9>*)this) = A;
    }
    inline void Set(const LA::AlignedMatrix2x3f& Arv,
        const LA::AlignedMatrix2x3f& Arba, const LA::AlignedMatrix2x3f& Arbw)
    {
...
public:
    inline CC() {}
    inline CC(const LA::AlignedMatrix6x6f& A)
    {
    ...
    inline void Increase(const LA::SymmetricMatrix3x3f& App,
        const LA::AlignedMatrix3x3f& Apr, const LA::SymmetricMatrix3x3f& Arr)
    {
        Increase00(App);
        Increase03(Apr);
        Increase33(Arr);
    ...
    inline void Increase(
        const LA::AlignedMatrix3x3f* Ap, const LA::AlignedMatrix3x3f* Ar)
    {
    ...
    inline void operator+=(const LA::SymmetricMatrix6x6f& A)
    {
        ...
        _A.m_00_01_02_03() += xp128f::get(&A.m00());
        _A[0][4] += A.m04();
        _A[0][5] += A.m05();
        _A[1][1] += A.m11();
        _A.m_12_13_14_15() += xp128f::get(&A.m12());
        _A[2][2] += A.m22();
        _A[2][3] += A.m23();
        _A[2][4] += A.m24();
        _A[2][5] += A.m25();
...
public:
    inline CM() {}
    inline CM(const LA::AlignedMatrixMxNf<6, 9>& A)
    {
        *((LA::AlignedMatrixMxNf<6, 9>*)this) = A;
    }
    inline void Set(const LA::AlignedMatrix3x3f& Apv,
        const LA::AlignedMatrix3x3f& Apba, const LA::AlignedMatrix3x3f& Apbw,
        const LA::AlignedMatrix3x3f& Arv, const LA::AlignedMatrix3x3f& Arba,
        const LA::AlignedMatrix3x3f& Arbw)
    {
    ...
    inline void Set(const LA::AlignedMatrix3x3f& Arv)
    {
        MakeZero();
        SetBlock(Arv);
    }
...
public:
    inline MC() {}
    inline void Set(const LA::AlignedMatrix3x3f& Avp,
        const LA::AlignedMatrix3x3f& Avr, const LA::AlignedMatrix3x3f& Abap,
        const LA::AlignedMatrix3x3f& Abar, const LA::AlignedMatrix3x3f& Abwp,
        const LA::AlignedMatrix3x3f& Abwr)
    {
        LA::AlignedMatrix9x6f::Set(Avp, Avr, Abap, Abar, Abwp, Abwr);
    }
    inline void Set(const LA::AlignedMatrix3x3f* Av,
        const LA::AlignedMatrix3x3f* Aba, const LA::AlignedMatrix3x3f* Abw)
    {
        Set(Av[0], Av[1], Aba[0], Aba[1], Abw[0], Abw[1]);
    }
    inline void Set(const LA::AlignedMatrix3x3f& Avr)
    {
        MakeZero();
        SetBlock(Avr);
    }
...
public:
    inline MM() {}
    inline MM(const LA::AlignedMatrixMxNf<9, 9>& A)
    {
        *((LA::AlignedMatrixMxNf<9, 9>*)this) = A;
    }
    inline MM(const LA::AlignedMatrix9x9f& A)
    {
        *((LA::AlignedMatrix9x9f*)this) = A;
    }
    inline void Set(const LA::SymmetricMatrix3x3f& Avv, const float Ababa,
        const float Abwbw)
    {
        MakeZero();
    ...
    inline void Set(const LA::AlignedMatrix3x3f& Avv,
        const LA::AlignedMatrix3x3f& Abav, const float Ababa,
        const LA::AlignedMatrix3x3f& Abwv, const float Abwbw)
    {
        MakeZero();
    ...
    inline void Increase(const LA::SymmetricMatrix3x3f& Avv,
        const LA::AlignedMatrix3x3f& Avba, const LA::AlignedMatrix3x3f& Avbw,
        const LA::SymmetricMatrix3x3f& Ababa,
        const LA::AlignedMatrix3x3f& Ababw,
        const LA::SymmetricMatrix3x3f& Abwbw)
    {
    ...
    inline void Increase(const LA::AlignedMatrix3x3f* Av,
        const LA::AlignedMatrix3x3f* Aba, const LA::AlignedMatrix3x3f* Abw,
...
inline void ABT(const LA::AlignedMatrixMxNf<M, N>& A,
...
template <int M, int N, int K, class BLOCK_ABT>
inline void AddABTTo(const LA::AlignedMatrixMxNf<M, N>& A,
    const LA::AlignedMatrixMxNf<K, N>& B, BLOCK_ABT& ABT)
{
    for (int i = 0; i < M; ++i)
    {
...
inline void AddAbTo(
    const LA::AlignedMatrixMxNf<M, N>& A, const BLOCK_B& b, BLOCK_ABT& ABT)
{
    for (int i = 0; i < M; ++i)
    {
        ABT[i] += A(i).Dot(b);
...
public:
    inline C() {}
    inline C(const AlignedVector<Element::C>& V)
    {
        *((AlignedVector<Element::C>*)this) = V;
    }
...
public:
    inline RC() {}
    inline RC(const AlignedVector<Element::RC>& V)
    {
        *((AlignedVector<Element::RC>*)this) = V;
    }
...
public:
    inline RM() {}
    inline RM(const AlignedVector<Element::RM>& V)
    {
        *((AlignedVector<Element::RM>*)this) = V;
    }
...
public:
    inline CC() {}
    inline CC(const AlignedVector<Element::CC>& V)
    {
        *((AlignedVector<Element::CC>*)this) = V;
    }
...
public:
    inline CM() {}
    inline CM(const AlignedVector<Element::CM>& V)
    {
        *((AlignedVector<Element::CM>*)this) = V;
    }
...
public:
    inline MC() {}
    inline MC(const AlignedVector<Element::MC>& V)
    {
        *((AlignedVector<Element::MC>*)this) = V;
    }
...
public:
    inline MM() {}
    inline MM(const AlignedVector<Element::MM>& V)
    {
        *((AlignedVector<Element::MM>*)this) = V;
    }
...
public:
    inline CC() {}
    inline CC(const AlignedMatrixX<Element::CC>& A)
    {
        *((AlignedMatrixX<Element::CC>*)this) = A;
    }
...
template <class BLOCK_A, class BLOCK_B, class BLOCK_ABT>
inline void AddABTTo(const AlignedVector<BLOCK_A>& A,
    const AlignedVector<BLOCK_B>& B, AlignedMatrixX<BLOCK_ABT>& ABT)
{
...
template <class BLOCK_A, class BLOCK_B, class BLOCK_ABT>
inline void AddABTToUpper(const AlignedVector<BLOCK_A>& A,
    const AlignedVector<BLOCK_B>& B, AlignedMatrixX<BLOCK_ABT>& ABT)
{
    const int N = A.Size();
#ifdef CFG_DEBUG
...
template <class BLOCK_A, class BLOCK_B, class BLOCK_ABT>
inline void AddABTToUpper(const AlignedVector<BLOCK_A>& A,
    const AlignedMatrixX<BLOCK_B>& B, AlignedMatrixX<BLOCK_ABT>& ABT)
{
    const int N = A.Size();
#ifdef CFG_DEBUG
...
inline void EigenConvert(
    const EigenMatrixXf& e_A, CC& A, const bool symmetric = true)
{
    ...
    {
        for (int i2 = symmetric ? i1 : 0, j2 = symmetric ? j1 : 0; i2 < Nc;
             ++i2, j2 += 6)
        {
            A[i1][i2] =
                EigenMatrix6x6f(e_A.block<6, 6>(j1, j2)).GetAlignedMatrix6x6f();
        }
    }
}
    ...
    const int verbose = 1, const std::string str = "")
{
    ...
    if (A.Symmetric())
    {
        ...
        for (int i1 = 0, j1 = 0; j1 < Nx6; ++i1, j1 += 6)
        {
            ...
            {
                const EigenMatrix6x6f e_A1 =
                    EigenMatrix6x6f(e_A.block<6, 6>(j1, j2));
                ...
                const EigenMatrix6x6f e_A3 =
                    EigenMatrix6x6f(e_A.block<6, 6>(j2, j1).transpose());
                scc =
                    e_A1.AssertEqual(
                        e_A3, verbose, str + UT::String("[%d][%d]", i2, i1)) &&
                    scc;
            }
        }
    }
...
public:
    ...
    public:
        ...
        inline void operator=(const Jacobian& J)
        {
            m_Jr = J.m_Jr;
            m_Jc.Set(J.m_Jc);
        }
    ...
    public:
        ...
        inline void operator=(const ErrorJacobian& Je)
        {
            m_e = Je.m_e;
            m_J = Je.m_J;
        }
    ...
    public:
        ...
        public:
            ...
            inline int BindSize(const int N) const
            {
                return m_JcT.BindSize(N) + m_JTAc0.BindSize(N) +
                       m_JTAc.BindSize(N, N, true) + m_Aec.BindSize(N);
            }
            inline void Set(const bool g,
                const ErrorJacobian& Je /*, const LA::AlignedMatrix2x3f &Jr*/,
                ...
                const Matrix::CC& Acc)
            {
                ...
                if (m_g)
                {
                    ...
                    const xp128f erx = xp128f::get(er.x()),
                                 ery = xp128f::get(er.y());
                    for (int i = 0; i < N; ++i)
                    {
                        ...
                        LA::AlignedMatrix2x3f::AddABTTo(
                            _Arp, _JcT.m_Jpp1, SArp);
                        LA::AlignedMatrix2x3f::AddABTTo(
                            _Arp, _JcT.m_Jpr1, SArr);
                        LA::AlignedMatrix2x3f::AddABTTo(
                            _Arr, _JcT.m_Jrr1, SArr);
                        ...
                        JTAc.MakeZero3x6();
                        LA::AlignedMatrix2x3f::ATB(Jr, _Arp, _JTAc);
                        JTAc.Set30(_JTAc);
                        LA::AlignedMatrix2x3f::ATB(Jr, _Arr, _JTAc);
                        JTAc.Set33(_JTAc);
                        Element::C& Aec = m_Aec[i];
                        LA::AlignedMatrix2x3f::ATb(_Arp, erx, ery, _Aec);
                        Aec.Set012(_Aec);
                        LA::AlignedMatrix2x3f::ATb(_Arr, erx, ery, _Aec);
                        Aec.Set345(_Aec);
                    }
                ...
                for (int i = 0; i < N; ++i)
                {
                    ...
                    for (int j = 0; j < N; ++j)
                    {
                        ...
                        LA::AlignedMatrix6x6f::AddABTTo00(
                            _JcT.m_Jpp1, _App, JTAc1);
                        LA::AlignedMatrix6x6f::AddABTTo03(
                            _JcT.m_Jpp1, _Arp, JTAc1);
                        LA::AlignedMatrix6x6f::AddABTTo30(
                            _JcT.m_Jpr1, _App, JTAc1);
                        LA::AlignedMatrix6x6f::AddABTTo30(
                            _JcT.m_Jrr1, _Apr, JTAc1);
                        LA::AlignedMatrix6x6f::AddABTTo33(
                            _JcT.m_Jpr1, _Arp, JTAc1);
                        LA::AlignedMatrix6x6f::AddABTTo33(
                            _JcT.m_Jrr1, _Arr, JTAc1);
                        if (j <= i)
                        {
                            Element::CC& JTAc2 = m_JTAc[j][i];
                            LA::AlignedMatrix6x6f::ABTTo00(
                                _JcT.m_Jpp2, _App, JTAc2);
                            LA::AlignedMatrix6x6f::ABTTo03(
                                _JcT.m_Jpp2, _Arp, JTAc2);
                            LA::AlignedMatrix6x6f::ABTTo30(
                                _JcT.m_Jrr2, _Apr, JTAc2);
                            LA::AlignedMatrix6x6f::ABTTo33(
                                _JcT.m_Jrr2, _Arr, JTAc2);
                        }
                        const Element::EC& _ec = Je.m_e.m_ec[j];
                        LA::AlignedMatrix3x3f::AddAbTo(
                            _App, _ec.m_ep, &Aec.v0());
                        LA::AlignedMatrix3x3f::AddAbTo(
                            _Apr, _ec.m_er, &Aec.v0());
                        LA::AlignedMatrix3x3f::AddAbTo(
                            _Arp, _ec.m_ep, &Aec.v3());
                        LA::AlignedMatrix3x3f::AddAbTo(
                            _Arr, _ec.m_er, &Aec.v3());
                    }
                }
            }
            inline void Get(const LA::AlignedMatrix2x3f& Jr, const xp128f& w,
                const Element::R& br, const Vector::C& bc, Matrix::CC* A,
                Vector::C* b) const
            {
                const int N = m_JcT.Size(), _N = N + 1;
#ifdef CFG_DEBUG
                ...
                if (m_g)
                {
                    ...
                    A00.MakeZero3x3();
                    LA::AlignedMatrix2x3f::ATB(_AJrp, Jr, _A);
                    A00.Set03(_A);
                    LA::AlignedMatrix2x3f::ATBToUpper(_AJrr, Jr, _A);
                    A00.Set33(_A);
                    Element::R Aepbr;
                ...
                for (int i = 0, _i = 1; i < N; ++i, ++_i)
                {
                    ...
                    LA::SymmetricMatrix6x6f::AddABTTo00(
                        _JTApp, JTi.m_Jpp1, A00);
                    LA::AlignedMatrix6x6f::AddABTTo03(_JTApp, JTi.m_Jpr1, A00);
                    LA::AlignedMatrix6x6f::AddABTTo03(_JTApr, JTi.m_Jrr1, A00);
                    LA::SymmetricMatrix6x6f::AddABTTo33(
                        _JTArp, JTi.m_Jpr1, A00);
                    LA::SymmetricMatrix6x6f::AddABTTo33(
                        _JTArr, JTi.m_Jrr1, A00);
    ...
    public:
        ...
        {
            const int _N = N + 1;
            return m_Je.BindSize(N) + m_A.BindSize(_N, _N, true) +
                   m_b.BindSize(_N);
        }
    ...
    public:
        ...
        inline void Accumulate(
            const Error& e, const float F, const int iFrm = -1)
        {
            UT::ES<float, int>::Accumulate(F, F, iFrm);
            if (e.m_er.Valid())
                m_ESr.Accumulate(ESError(LA::AlignedVector3f(e.m_er, 0.0f),
            ...
            for (int i = 0; i < N; ++i)
            {
                ...
                m_ESr.Accumulate(
                    ESError(ec.m_er, UT_FACTOR_RAD_TO_DEG), -1.0f, iFrm);
            }
        }
...
public:
    ...
    inline void Initialize(const float w, const int iKFr, const Rigid3D& Tr,
        const float s2r, const bool newKF, const Rigid3D* T0 = NULL,
    ...
    inline bool Initialize(const float w, const int iKF1, const int iKF2,
        const Rigid3D& T, const LA::AlignedMatrix6x6f& S)
    {
        m_Acc.Resize(1, 1, true);
...
#ifdef CFG_DEBUG
    inline void DebugSetMeasurement(
        const Rigid3D& Tr, const bool newKF, const Rigid3D* T0 = NULL)
    {
    ...
    inline void Insert(const float w, const int i, const int iKF,
        const Rigid3D& T, const float s2p, const float s2r,
    ...
    inline void DeleteKeyFrame(
        const int iKF, const std::vector<int>::iterator* i = NULL)
    {
        if (m_iKFr == iKF)
        {
            // Invalidate();
        ...
        const std::vector<int>::iterator _i =
            i ? *i : std::lower_bound(m_iKFs.begin(), m_iKFs.end(), iKF);
        if (_i == m_iKFs.end())
        {
            return;
        }
    ...
    //  inline void GetReferencePose(const Rigid3D &Tr, Rigid3D *_Tr, Rigid3D
    //  *TrI) const {
    //#ifdef CFG_DEBUG
    ...
    //    TrI->GetInverse(*_Tr);
    //  }
    inline void GetReferencePose(
        const Rigid3D& Tr, Rigid3D* _Tr, Rigid3D* TrI) const
    {
#ifdef CFG_DEBUG
        UT_ASSERT(m_Zps.Size() == static_cast<int>(m_iKFs.size()) + 1);
#endif
    ...
    //  inline void GetPose(const Rigid3D &TrI, const int i, Rigid3D *Tri,
    //  Rigid3D *Ti) const {
    //#ifdef CFG_DEBUG
    //    UT_ASSERT(i < static_cast<int>(m_iKFs.size()));
    //#endif
    ...
    inline Rotation3D GetReferenceRotationMeasurement(
        const float* x /* = NULL*/, const float eps) const
    {
#ifdef CFG_DEBUG
        UT_ASSERT(m_Zps.Size() == static_cast<int>(m_iKFs.size()) + 1);
#endif
    ...
    inline LA::AlignedVector3f GetReferenceRotationError(
        const Rotation3D& R, const float* x /* = NULL*/, const float eps) const
    {
        const Rotation3D eR = GetReferenceRotationMeasurement(x, eps) /
                              GetReferenceRotationState(R);
        const LA::Vector2f e = eR.GetRodriguesXY(eps);
        return LA::AlignedVector3f(e.x(), e.y(), 0.0f);
    }
    inline Rotation3D GetRotationState(
        const Rotation3D& R1, const Rotation3D& R2) const
    {
        return R1 / R2;
    }
    inline const Rotation3D GetRotationMeasurement(
        const int i, const float* x /* = NULL*/, const float eps) const
    {
        if (x)
        {
            Rotation3D dR;
    ...
    inline LA::AlignedVector3f GetRotationError(const Rotation3D& R1,
        const Rotation3D& R2, const int i, const float* x /* = NULL*/,
        const float eps) const
    {
        const Rotation3D eR =
            GetRotationMeasurement(i, x, eps) / GetRotationState(R1, R2);
        return eR.GetRodrigues(eps);
    }
    inline LA::AlignedVector3f GetPositionState(
        const Rigid3D& C1, const Rigid3D& C2) const
    {
        const Point3D p2 = C2.GetPosition();
        return C1.GetTranslation() + C1.GetAppliedRotation(p2);
    }
    inline LA::AlignedVector3f GetPositionMeasurement(
    ...
    inline LA::AlignedVector3f GetPositionError(const Rigid3D& C1,
        const Rigid3D& C2, const int i, const float* x = NULL) const
    {
        return GetPositionState(C1, C2) - GetPositionMeasurement(i, x);
    }
    inline void GetError(const Rigid3D& C1, const Rigid3D& C2, const int i,
        Element::EC* e, const float eps) const
    {
        GetError(C1, C2, m_Zps[i], e, eps);
    }
    static inline void GetError(const Rigid3D& C1, const Rigid3D& C2,
        const Rigid3D& Z21, Element::EC* e, const float eps)
    {
    ...
    inline void GetError(
        const AlignedVector<Rigid3D>& Cs, Error* e, const float eps) const
    {
        Rotation3D eR, Rt;
    ...
    inline void GetError(const ErrorJacobian& Je,
        ...
        const std::vector<const LA::AlignedVector3f*>& xrs, Error* e) const
    {
        ...
        for (int i = 0; i < N; ++i)
        {
            ...
            {
                LA::AlignedMatrix3x3f::AddAbTo(
                    Jc.m_Jpp1, *xp1, (float*)&ec.m_ep);
            }
            if (xr1)
            {
                LA::AlignedMatrix3x3f::AddAbTo(
                    Jc.m_Jrr1, *xr1, (float*)&ec.m_er);
                LA::AlignedMatrix3x3f::AddAbTo(
                    Jc.m_Jpr1, *xr1, (float*)&ec.m_ep);
            }
            if (xp2)
            {
                LA::AlignedMatrix3x3f::AddAbTo(
                    Jc.m_Jpp2, *xp2, (float*)&ec.m_ep);
            }
            if (xr2)
            {
                LA::AlignedMatrix3x3f::AddAbTo(
                    Jc.m_Jrr2, *xr2, (float*)&ec.m_er);
            }
        }
    }
    inline void GetErrorJacobian(const AlignedVector<Rigid3D>& Cs,
        ErrorJacobian* Je
    ...
    inline void GetFactor(const float w, const AlignedVector<Rigid3D>& Cs,
        Factor* A, Factor::Auxiliary* U, const float eps) const
    {
        // LA::AlignedMatrix2x3f Jr;
        GetErrorJacobian(Cs, &A->m_Je /*, &Jr*/, eps);
        const xp128f _w = xp128f::get(w);
        U->Set(m_Zps.Size() != static_cast<int>(m_iKFs.size()),
            A->m_Je /*, Jr*/,
            _w,
            m_Arr,
            m_Arc,
    ...
    inline float GetCost(const float w, const Error& e) const
    {
        ...
        Element::C bc;
        const xp128f erx = xp128f::get(e.m_er.x()),
                     ery = xp128f::get(e.m_er.y());
        // const xp128f _s = xp128f::get(s);
        for (int i = 0; i < N; ++i)
        {
            if (g)
    ...
    inline void GetReduction(const float w, const Factor& A,
        const AlignedVector<Rigid3D>& Cs,
        const std::vector<const LA::AlignedVector3f*>& xps,
        const std::vector<const LA::AlignedVector3f*>& xrs, Reduction* Ra,
        Reduction* Rp, const float eps) const
    {
    ...
    inline void GetResidual(const AlignedVector<Rigid3D>& Cs, Error* e,
        Vector::C* ec, Element::R* rr, Vector::C* rc, const float eps) const
    {
        GetError(Cs, e, eps);
        const int N = static_cast<int>(m_iKFs.size());
        Vector::C& _ec = *ec;
        ...
        for (int i = 0; i < N; ++i)
        {
            ...
            for (int j = i; j < N; ++j)
            {
                LA::AlignedMatrix6x6f::AddAbTo(
                    m_Acc[i][j], _ec[j], (float*)&rci);
                if (j == i)
                {
                    continue;
                }
    ...
    bool Marginalize(
        const int i, AlignedVector<float>* work, const float* eps = NULL);
    bool MarginalizeUninformative(const float w, const float s2p,
        const float s2r, std::vector<int>* iks, AlignedVector<float>* work,
        const float* eps = NULL);
    void SetPriorEquation(
        const Matrix::X& A, const Vector::X& b, const bool g = true);
    void GetPriorEquation(Matrix::X* A, Vector::X* b = NULL,
        const bool symmetric = true, const bool g = true) const;
    bool GetPriorMeasurement(const Element::T w, Matrix::X* S,
        Vector::X* x /* = NULL*/, Element::T* xTb /* = NULL*/,
        const Element::T* eps /* = NULL*/) const;
    bool GetPriorMeasurement(const float w, LA::AlignedMatrixXf* S,
        LA::AlignedVectorXf* x, float* xTb, AlignedVector<float>* work,
...
public:
    ...
    public:
        ...
        inline void Set(const ErrorJacobian& J)
        {
            Set(J.m_e);
            Set(J.m_J);
        }
            ...
            const std::string str = "") const
        {
            ...
            {
                const Element::EC& ec = e.m_ec[i];
                const EigenVector6f e_ec1 =
                    EigenVector6f(m_e.block<6, 1>(j, 0));
                const EigenVector6f e_ec2 = EigenVector6f(ec.m_ep, ec.m_er);
                scc = e_ec1.AssertEqual(
                          e_ec2, verbose, UT::String(".m_ec[%d]", i)) &&
                      scc;
            }
            return scc;
        }
            ...
            const std::string str = "") const
        {
            ...
            scc = EigenMatrixXf(m_J.block(0, 0, 2, 3))
                      .AssertZero(verbose, str + ".Zero[r]", -1.0f, -1.0f) &&
                  scc;
            scc = EigenMatrixXf(m_J.block(0, 6, 2, Nx6))
                      .AssertZero(verbose, str + ".Zero[r]", -1.0f, -1.0f) &&
                  scc;
            ...
            for (int i = 0, j = 2, k = 6; i < N; ++i, j += 6, k += 6)
            {
                ...
                scc = e_Jc1.AssertEqual(
                          e_Jc2, verbose, str + UT::String(".m_Jc[%d]", i)) &&
                      scc;
                const std::string _str = str + UT::String(".Zero[%d]", i);
                scc = EigenMatrixXf(m_J.block(j, 6, 6, k - 6))
                          .AssertZero(verbose, _str, -1.0f, -1.0f) &&
                      scc;
                scc = EigenMatrixXf(m_J.block(j, k + 6, 6, Nx6 - k))
                          .AssertZero(verbose, _str, -1.0f, -1.0f) &&
                      scc;
            }
            return scc;
    ...
    public:
        inline EigenPrior() {}
        inline EigenPrior(const EigenMatrixXf& e_A, const EigenVectorXf& e_b)
            : m_A(e_A), m_b(e_b)
        {
        }
        inline EigenPrior(const Element::RR& Arr, const Vector::RC& Arc,
            const Matrix::CC& Acc, const Element::R& br, const Vector::C& bc,
            const float w = 1.0f, const bool pad = false)
        {
        ...
        inline void Set(const Element::RR& Arr, const Vector::RC& Arc,
            const Matrix::CC& Acc, const Element::R& br, const Vector::C& bc,
            const float w = 1.0f, const bool pad = false)
        {
            const int N = bc.Size();
...
#endif
            Arr =
                EigenMatrix2x2f(m_A.block<2, 2>(0, 0)).GetSymmetricMatrix2x2f();
        ...
        {
            return AssertEqual(
                Z.m_Arr, Z.m_Arc, Z.m_Acc, Z.m_br, Z.m_bc, verbose, str);
        }
        inline bool AssertEqual(const Element::RR& Arr, const Vector::RC& Arc,
            const Matrix::CC& Acc, const Element::R& br, const Vector::C& bc,
...
public:
    EigenErrorJacobian EigenGetErrorJacobian(
        const AlignedVector<Rigid3D>& Cs, const float eps) const;
    EigenFactor EigenGetFactor(
        const float w, const AlignedVector<Rigid3D>& Cs, const float eps) const;
    ...
    void EigenGetResidual(const AlignedVector<Rigid3D>& Cs, EigenVectorXf* e_r,
        const float eps) const;
    void EigenGetPriorMeasurement(
        const float w, EigenMatrixXf* e_S, EigenVectorXf* e_x = NULL) const;
#endif
};
...
public:
    ...
    public:
        ...
        public:
            ...
            inline void Set(
                const ErrorJacobian& Je, const xp128f& w, const Element::MM& A)
            {
            ...
            inline void Get(const Error& e, LA::SymmetricMatrix3x3f* Arr,
                LA::AlignedMatrix3x9f* Arm, LA::SymmetricMatrix9x9f* Amm,
                LA::Vector3f* br, LA::Vector9f* bm) const
            {
                LA::SymmetricMatrix3x3f::ABT(m_JTArv, m_JT.m_Jvr, *Arr);
                LA::AlignedMatrix3x9f& _Arm = *Arm;
                LA::AlignedMatrix3x3f::ABT(
                    m_JTArv, m_JT.m_Jvv, _Arm[0], _Arm[1], _Arm[2]);
                float* _br = &br->v0();
            ...
            inline void Get(const xp128f& w, const Element::M& b,
                LA::SymmetricMatrix3x3f* Arr, LA::AlignedMatrix3x9f* Arm,
                LA::SymmetricMatrix9x9f* Amm, LA::Vector3f* br,
    ...
    public:
            ...
            const Error& e, const float F, const int iFrm = -1)
        {
            ...
            m_ESbw.Accumulate(
                ESError(e.m_ebw, UT_FACTOR_RAD_TO_DEG), -1.0f, iFrm);
        }
        inline void Print(const std::string str = "", const bool l = true) const
        {
            if (!Valid())
    ...
    inline void Initialize(const float w, const float s2v, const float s2ba,
        const float s2bw, const Camera* C = NULL)
    {
        if (C)
        {
    ...
    inline void GetMotion(const Rotation3D& R, LA::AlignedVector3f* v,
        LA::AlignedVector3f* ba, LA::AlignedVector3f* bw) const
    {
    ...
    inline LA::AlignedVector3f GetVelocityMeasurement(
    ...
    inline LA::AlignedVector3f GetVelocityError(
        const Camera& C, const float* x) const
    {
    ...
    inline LA::AlignedVector3f GetBiasAccelerationMeasurement(
        const float* x = NULL) const
    {
        if (x)
        {
    ...
    inline LA::AlignedVector3f GetBiasAccelerationError(
        const Camera& C, const float* x = NULL) const
    {
    ...
    inline LA::AlignedVector3f GetBiasGyroscopeMeasurement(
        const float* x = NULL) const
    {
        if (x)
        {
    ...
    inline LA::AlignedVector3f GetBiasGyroscopeError(
        const Camera& C, const float* x = NULL) const
    {
    ...
    inline void GetFactor(
        const float w, const Camera& C, Factor* A, Factor::Auxiliary* U) const
    {
    ...
    inline float GetCost(
        const float w, const Error& e, const Element::M& Ae) const
    {
        Element::M _e, b;
        e.Get(&_e);
    ...
    inline void GetResidual(
        const Camera& C, Error* e, Element::M* em, Element::M* r) const
    {
        GetError(C, e);
...
public:
    ...
    public:
            ...
            const std::string str = "") const
        {
            ...
            bool scc = true;
            scc =
                e_Arr.AssertEqual(A.m_Arr.m_A, verbose, str + ".m_Arr") && scc;
            scc = e_Arm.AssertEqual(A.m_Arm, verbose, str + ".m_Arm") && scc;
            scc =
                e_Amm.AssertEqual(A.m_Amm.m_A, verbose, str + ".m_Amm") && scc;
    ...
    public:
        inline void Initialize(
            const float w, const float s2v, const float s2ba, const float s2bw)
        {
            m_A.Resize(9, 9);
            m_A.MakeZero();
            m_b.Resize(9);
        ...
        {
            UT_ASSERT(
                m_A.GetRows() == 9 && m_A.GetColumns() == 9 && m_b.Size() == 9);
            bool scc = true;
...
public:
    ...
    float EigenGetCost(const float w, const Camera& C,
        const EigenVector3f& e_xr, const EigenVector9f& e_xm) const;
...
public:
    ...
    // inline bool Invalid() const { return Pose::Invalid() ||
    // Motion::Invalid(); } inline void Invalidate() { Pose::Invalidate();
    // Motion::Invalidate(); }
    ...
    inline void Initialize(const float w, const int iKFr, const Rigid3D& Tr,
        const float s2r, const Motion& Zp, const bool newKF,
        const Rigid3D* T0 = NULL, const float s2cp = 0.0f,
        const float s2cr = 0.0f)
    {
    ...
    inline void Update(const int i1, const int i2,
        const Camera::Factor::Unitary::CC& A11,
        const Camera::Factor::Binary::CC& A12,
        const Camera::Factor::Unitary::CC& A22)
    {
        m_Acc[i1][i1] += A11.m_A;
    ...
    inline void GetError(const Rigid3D& Tr, const Camera& C,
        LA::Vector2f* er /* = NULL*/, Element::EC* ec /* = NULL*/,
        Element::EM* em /* = NULL*/, const float eps) const
    {
        const int N = static_cast<int>(m_iKFs.size());
        if (er)
        {
    ...
    inline void GetError(const AlignedVector<Rigid3D>& Cs, const Camera& C,
    ...
    inline void GetResidual(const AlignedVector<Rigid3D>& Cs, const Camera& C,
        Error* e, Vector::C* ec, Element::M* em, Element::R* rr, Vector::C* rc,
    ...
    void GetPriorEquation(
        Matrix::X* A, Vector::X* b = NULL, const bool symmetric = true) const;
    bool GetPriorMeasurement(const Element::T w, Matrix::X* S,
        Vector::X* x /* = NULL*/, Element::T* xTb /* = NULL*/,
        const Element::T* eps /* = NULL*/) const;
    bool GetPriorMeasurement(const float w, LA::AlignedMatrixXf* S,
    ...
    bool PropagateLF(const IMU::Delta::Factor::Auxiliary::RelativeLF& A,
    ...
    bool PropagateKF(const Rigid3D& Tr, const Camera& C,
        ...
        AlignedVector<float>* work, const float* eps = NULL);
    bool PropagateKF(const IMU::Delta::Factor::Auxiliary::RelativeKF& A,
        LA::AlignedVectorXf* x, AlignedVector<float>* work,
        const float* eps = NULL) const;
    bool GetPriorPose(const int iKF, Pose* Zp, AlignedVector<float>* work,
        const float* eps = NULL) const;
    bool GetPriorMotion(
        Motion* Zp, AlignedVector<float>* work, const float* eps = NULL) const;
...
public:
    ...
    {
    public:
        inline void Initialize(const float w, const float s2r,
            const Motion::EigenPrior& e_Ap, const float s2cp = 0.0f,
            const float s2cr = 0.0f)
        {
            m_A.Resize(17, 17);
            m_A.MakeZero();
...
#ifdef CFG_DEBUG
            UT_ASSERT(e_Ap.m_A.GetRows() == 9 && e_Ap.m_A.GetColumns() == 9 &&
                      e_Ap.m_b.Size() == 9);
#endif
        ...
        inline void Set(const Element::RR& Arr, const Vector::RC& Arc,
            const Element::RM& Arm, const Matrix::CC& Acc,
            const Vector::CM& Acm, const Element::MM& Amm, const Element::R& br,
            const Vector::C& bc, const Element::M& bm, const bool pad = false)
        {
            const Pose::EigenPrior e_Arc =
                Pose::EigenPrior(Arr, Arc, Acc, br, bc, 1.0f, pad);
            const int Nx6 = bc.Size() * 6, Nrc = e_Arc.m_b.Size(),
                      Nrcm = Nrc + 9;
        ...
        inline void Get(Element::RR& Arr, Vector::RC& Arc, Element::RM& Arm,
            Matrix::CC& Acc, Vector::CM& Acm, Element::MM& Amm, Element::R& br,
            Vector::C& bc, Element::M& bm) const
        {
...
#endif
            const Pose::EigenPrior e_Arc(
                EigenMatrixXf(m_A.block(0, 0, Nrc, Nrc)),
                EigenVectorXf(m_b.block(0, 0, Nrc, 1)));
            e_Arc.Get(Arr, Arc, Acc, br, bc);
            Arm =
                EigenMatrix2x9f(m_A.block<2, 9>(0, Nrc)).GetAlignedMatrixMxNf();
            EigenConvert(EigenMatrixXf(m_A.block(2, Nrc, Nx6, 9)), Acm);
            Amm = EigenMatrix9x9f(m_A.block<9, 9>(Nrc, Nrc))
                      .GetAlignedMatrixMxNf();
            bm = EigenVector9f(m_b.block<9, 1>(Nrc, 0)).GetAlignedVector9f();
        }
        inline void Insert(
            const float w, const int i, const float s2p, const float s2r)
        {
            const int j = 2 + i * 6;
            m_A.InsertZero(j, 6);
            m_A(j, j) = m_A(j + 1, j + 1) = m_A(j + 2, j + 2) =
                UT::Inverse(s2p, w);
            m_A(j + 3, j + 3) = m_A(j + 4, j + 4) = m_A(j + 5, j + 5) =
                UT::Inverse(s2r, w);
            m_b.InsertZero(j, 6);
        }
        inline void Update(
            const int i, const EigenMatrix6x6f& e_A, const EigenVector6f& e_b)
        {
            const int j = 2 + i * 6;
        ...
        inline void Update(const int i1, const int i2,
            const EigenMatrix6x6f& e_A11, const EigenMatrix6x6f& e_A12,
            const EigenMatrix6x6f& e_A22, const EigenVector6f& e_b1,
            const EigenVector6f& e_b2)
        {
        ...
        inline bool AssertEqual(const Element::RR& Arr, const Vector::RC& Arc,
            const Element::RM& Arm, const Matrix::CC& Acc,
            const Vector::CM& Acm, const Element::MM& Amm, const Element::R& br,
            const Vector::C& bc, const Element::M& bm, const int verbose = 1,
            const std::string str = "") const
        {
            const int Nrcm = m_b.Size(), Nrc = Nrcm - 9, Nx6 = Nrc - 2;
            bool scc = true;
