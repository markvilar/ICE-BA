...
public:
    ...
    inline EigenDecomposeResult EigenDecompose(
        LA::AlignedMatrix2x2f& U, LA::Vector2f& l, const float eps) const
    {
        l.x() = (sxx() - syy()) * 0.5f;
    ...
    inline void EigenCompose(
        const LA::AlignedMatrix2x2f& U, const LA::Vector2f& l)
    {
...
public:
    ...
    static inline void apb(
        const AlignedVector3f& a, const Point3D& Xb, Point3D& Xapb)
    {
