...
inline Eigen::Vector4f XpQuaternionDerivative(
    const Eigen::Vector4f& q, const Eigen::Vector3f& omega)
{
...
void IntegrateQuaternion(const Eigen::Vector3f& omega_begin,
    const Eigen::Vector3f& omega_end, const XpQuaternion& q_begin,
    const float dt, XpQuaternion* q_end, XpQuaternion* q_mid = nullptr,
    XpQuaternion* q_fourth = nullptr, XpQuaternion* q_eighth = nullptr);
